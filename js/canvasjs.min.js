...
(function () {
    ...
    function Wa(k, m, v) {
        ...
        if (isNaN(s)) {
            try {
                k = "position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:" + k + "; font-size:" + m + "px; font-weight:" + v + ";";
                if (!wa) {
    ...
    function gb(k) {
        if (k._menuButton) k.exportEnabled ? Ka(k._menuButton) : ua(k._menuButton);
            ...
            W(
                ...
                function () {
                    "none" !== k._dropdownMenu.style.display ||
                        (k._dropDownCloseTime && 500 >= new Date().getTime() - k._dropDownCloseTime.getTime()) ||
                        ((k._dropdownMenu.style.display = "block"), k._menuButton.blur(), k._dropdownMenu.focus());
                },
                k.allDOMEventHandlers,
                !0
            );
            W(
                ...
                function () {
                    m ||
                        (pa(k._menuButton, { backgroundColor: k.toolbar.backgroundColorOnHover, color: k.toolbar.fontColorOnHover }),
                        0 >= navigator.userAgent.search("MSIE") && pa(k._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
                },
                k.allDOMEventHandlers,
                !0
            );
            W(
                ...
                function () {
                    m ||
                        (pa(k._menuButton, { backgroundColor: k.toolbar.backgroundColor, color: k.toolbar.fontColor }),
                        0 >= navigator.userAgent.search("MSIE") && pa(k._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
                },
                k.allDOMEventHandlers,
                !0
            );
    ...
    function hb(k) {
        ...
        //     var m = !1,
        //         v = !1;
        //     "undefined" === typeof qa.Chart.creditHref ? ((k.creditHref = Z("iuuqr;..b`ow`rkr/bnl.")), (k.creditText = Z("B`ow`rKR/bnl"))) : ((m = k.updateOption("creditText")), (v = k.updateOption("creditHref")));
        //     if (k.creditHref && k.creditText) {
        //         k._creditLink ||
        //             ((k._creditLink = document.createElement("a")),
        //             k._creditLink.setAttribute("class", "canvasjs-chart-credit d-none"),
        //             k._creditLink.setAttribute("title", "JavaScript Charts"),
        //             k._creditLink.setAttribute(
        //                 "style",
        //                 "outline:none;margin:0px;position:absolute;right:2px;top:" + (k.height - 14) + "px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"
        //             ),
        ...
        //             ? (k._creditLink.parentElement || k._canvasJSContainer.appendChild(k._creditLink), (k._creditLink.style.top = k.height - 14 + "px"))
    ...
    function va(k, m, v) {
        m.getAttribute("state") ||
            ((m.style.backgroundColor = k.toolbar.backgroundColor), (m.style.color = k.toolbar.fontColor), (m.style.border = "none"), pa(m, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
        m.getAttribute("state") !== v &&
            (m.setAttribute("state", v),
            m.setAttribute("type", "button"),
            pa(m, { padding: "5px 12px", cursor: "pointer", float: "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }),
            m.setAttribute("title", k._cultureInfo[v + "Text"]),
            (m.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + jb[v].image + "' alt='" + k._cultureInfo[v + "Text"] + "' />"));
    }
    function Ka() {
        for (var k = null, m = 0; m < arguments.length; m++) (k = arguments[m]), k.style && (k.style.display = "inline");
    }
    function ua() {
        for (var k = null, m = 0; m < arguments.length; m++) (k = arguments[m]) && k.style && (k.style.display = "none");
    }
    ...
    function X(k, m, v, s, w) {
        ...
        this.theme && r(this.parent) && r(m) && r(s)
            ? (k = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme])
            : this.parent &&
              this.parent.themeOptions &&
              this.parent.themeOptions[m] &&
              (null === s ? (k = this.parent.themeOptions[m]) : 0 < this.parent.themeOptions[m].length && ((s = Math.min(this.parent.themeOptions[m].length - 1, s)), (k = this.parent.themeOptions[m][s])));
        this.themeOptions = k;
    ...
    function ya(k, m) {
        ...
        if (r(this.options.margin) && k.options.subtitles)
            for (var v = k.options.subtitles, s = 0; s < v.length; s++)
                if (
                    ((r(v[s].horizontalAlign) && "center" === this.horizontalAlign) || v[s].horizontalAlign === this.horizontalAlign) &&
                    ((r(v[s].verticalAlign) && "top" === this.verticalAlign) || v[s].verticalAlign === this.verticalAlign) &&
    ...
    var V = 20,
        ...
        Ua = {
            ...
            subtitles: [{ fontFamily: Ea, fontSize: E, fontColor: ba, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
            data: [{ indexLabelFontFamily: w, indexLabelFontSize: E, indexLabelFontColor: ba, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
            axisX: [
                {
                    titleFontFamily: w,
                    titleFontSize: V,
                    ...
                    gridThickness: 0,
                    gridColor: G,
                    stripLines: [{ labelFontFamily: w, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }],
                    crosshair: { labelFontFamily: w, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ka, color: ea, thickness: 1, lineDashType: "dash" },
            ...
            legend: { fontFamily: w, fontSize: 14, fontColor: ba, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" },
    ...
    var V = 20,
        ...
        $a = {
            ...
            subtitles: [{ fontFamily: w, fontSize: E, fontColor: "#3A3A3A", fontWeight: "normal", verticalAlign: "top", margin: 5 }],
            data: [{ indexLabelFontFamily: w, indexLabelFontSize: E, indexLabelFontColor: "#666666", indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
            axisX: [
                {
                    titleFontFamily: w,
                    titleFontSize: V,
                    ...
                    gridThickness: 1,
                    gridColor: "#BBBBBB",
                    stripLines: [{ labelFontFamily: w, labelFontSize: E, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1 }],
                    crosshair: { labelFontFamily: w, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot" },
                    scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" },
                },
            ],
            axisX2: [
    ...
    Ea = {
        ...
        data: [{ indexLabelFontFamily: w, indexLabelFontSize: E, indexLabelFontColor: U, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
        axisX: [
            {
                titleFontFamily: w,
                titleFontSize: V,
                ...
                gridColor: G,
                stripLines: [{ labelFontFamily: w, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }],
                crosshair: { labelFontFamily: w, labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ka, color: ea, thickness: 1, lineDashType: "dash" },
        ...
        legend: { fontFamily: w, fontSize: 14, fontColor: ba, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" },
        toolTip: { fontFamily: w, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1, fontColor: U, backgroundColor: "rgba(0, 0, 0, .7)" },
    };
    G = "#FFFFFF";
    U = ba = "#FAFAFA";
    ea = "#40BAF1";
    ...
    var V = 20,
        ...
        ab = {
            ...
            dark2: {
                ...
                subtitles: [{ fontFamily: w, fontSize: E, fontColor: ba, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
                toolbar: { backgroundColor: "#666666", backgroundColorOnHover: "#FF7372", borderColor: "#FF7372", borderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" },
                data: [{ indexLabelFontFamily: w, indexLabelFontSize: E, indexLabelFontColor: U, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
                axisX: [
                    {
    ...
    (function () {
        ...
        I.obj = { trVs: "Ush`m!Wdsrhno", fntStr: "qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg", txtBl: "udyuC`rdmhod", fnt: "gnou", fSy: "ghmmRuxmd", fTx: "ghmmUdyu", grClr: "fsdx", cntx: "buy", tp: "unq" };
            ...
            return function (E, Q, N) {
                ...
                return (N = Q.replace(k, function (l) {
                    switch (l) {
                        ...
                        case "zzz":
                            return (0 < f ? "-" : "+") + aa(Math.floor(Math.abs(f) / 60), 2) + aa(Math.abs(f) % 60, 2);
                        default:
            ...
            for (T = E = L = I = Q = 0; 0 < N.length; )
                if (((m = N.pop()), "#" === m || "0" === m))
                    ...
                    ("E" !== m[0] && "e" !== m[0]) || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m)
                        ...
                        : ((m = 0 > X ? m.replace("+", "").replace("-", "") : m.replace("-", "")),
    ...
    X.prototype.set = function (k, m, r) {
        ...
        if ("options" === k) this.createUserOptions(m);
            ...
            window.console &&
                (s.publicProperties && s.publicProperties.hasOwnProperty(k) && "readOnly" === s.publicProperties[k]
    ...
    X.prototype.addTo = function (k, m, r, s) {
        ...
        w.hasOwnProperty(k) || (w.publicProperties && w.publicProperties.hasOwnProperty(k) && "readWrite" === w.publicProperties[k])
            ...
            : window.console &&
              (w.publicProperties && w.publicProperties.hasOwnProperty(k) && "readOnly" === w.publicProperties[k]
                  ? window.console.log('Property "' + k + '" is read-only.')
                  : window.console.log('Property "' + k + "\" doesn't exist. Please check for typo."));
    };
    ...
    X.prototype.updateOption = function (k) {
        ...
        this.theme && r(this.parent) && r(E) && r(I)
            ? (s = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme])
            : this.parent &&
              this.parent.themeOptions &&
              this.parent.themeOptions[E] &&
              (null === I ? (s = this.parent.themeOptions[E]) : 0 < this.parent.themeOptions[E].length && ((s = Math.min(this.parent.themeOptions[E].length - 1, I)), (s = this.parent.themeOptions[E][s])));
        this.themeOptions = s;
    ...
    X.prototype.addEventListener = function (k, m, r) {
        k && m && ((this._eventListeners[k] = this._eventListeners[k] || []), this._eventListeners[k].push({ context: r || this, eventHandler: m }));
    };
    ...
    X.prototype.dispatchEvent = function (k, m, r) {
        if (k && this._eventListeners[k]) {
            m = m || {};
            for (var s = this._eventListeners[k], w = 0; w < s.length; w++) s[w].eventHandler.call(s[w].context, m);
        }
    ...
    ya.prototype.setLayout = function () {
        if (this.text) {
            ...
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? (null === this.maxWidth && (this.maxWidth = m.width - 4 - D * ("center" === this.horizontalAlign ? 2 : 1)), (I = 0.5 * m.height - this.margin - 2), (E = 0))
                : "center" === this.verticalAlign &&
                  ("left" === this.horizontalAlign || "right" === this.horizontalAlign
                      ? (null === this.maxWidth && (this.maxWidth = m.height - 4), (I = 0.5 * m.width - this.margin - 2))
                      : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = m.width - 4), (I = 0.5 * m.height - 4)));
            var N;
            ...
            N = I.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? ("top" === this.verticalAlign ? ((w = m.y1 + 2), (G = "top")) : "bottom" === this.verticalAlign && ((w = m.y2 - 2 - N.height), (G = "bottom")),
                  "left" === this.horizontalAlign ? (s = m.x1 + 2) : "center" === this.horizontalAlign ? (s = m.x1 + m.width / 2 - N.width / 2) : "right" === this.horizontalAlign && (s = m.x2 - 2 - N.width - D),
                  (Q = this.horizontalAlign),
                  (this.width = N.width),
                  (this.height = N.height))
                : "center" === this.verticalAlign &&
                  ("left" === this.horizontalAlign
                      ? ((s = m.x1 + 2), (w = m.y2 - 2 - (this.maxWidth / 2 - N.width / 2)), (E = -90), (G = "left"), (this.width = N.height), (this.height = N.width))
                      : "right" === this.horizontalAlign
                      ? ((s = m.x2 - 2), (w = m.y1 + 2 + (this.maxWidth / 2 - N.width / 2)), (E = 90), (G = "right"), (this.width = N.height), (this.height = N.width))
                      : "center" === this.horizontalAlign && ((w = k.y1 + (k.height / 2 - N.height / 2)), (s = k.x1 + (k.width / 2 - N.width / 2)), (G = "center"), (this.width = N.width), (this.height = N.height)),
                  (Q = "center"));
            I.x = s;
            I.y = w;
            I.angle = E;
            I.horizontalAlign = Q;
            this._textBlock = I;
            k.layoutManager.registerSpace(G, { width: this.width + ("left" === G || "right" === G ? this.margin + 2 : 0), height: this.height + ("top" === G || "bottom" === G ? this.margin + 2 : 0) });
    ...
    w = Oa.Chart = (function () {
        ...
        function v(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e) c.push(a[0]);
                    ...
                    var z = (a[l].x - a[f].x) / b;
                    b = (a[l].y - a[f].y) / b;
                    c[c.length] = (a[u].x > a[f].x && 0 < z) || (a[u].x < a[f].x && 0 > z) ? { x: a[u].x + z / 3, y: a[u].y + b / 3 } : { x: a[u].x, y: a[u].y + b / 9 };
                    u = e;
                    f = 0 === u ? 0 : u - 1;
                    l = u === a.length - 1 ? u : u + 1;
        ...
        function w(a, d, c, b, e, f, l, u, z, h) {
            ...
            a.beginPath();
            z && 0 < u.thickness
                ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - n), a.lineTo(d + l.thickness / 2, Math.round((c + e) / 2) - n))
                : 0 < u.thickness && (a.moveTo(Math.round((d + b) / 2) - n, c + l.thickness / 2), a.lineTo(Math.round((d + b) / 2) - n, e - l.thickness / 2));
            a.stroke();
        ...
        function U(a, d, c, b) {
            ...
            if (this.options.customBreaks && 0 < this.options.customBreaks.length) {
                for (a = 0; a < this.options.customBreaks.length; a++)
                    this.customBreaks.push(new V(this.chart, "customBreaks", this.options.customBreaks[a], a, ++this.chart._eventManager.lastObjectId, this)),
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (!this._zoomButton) {
                    ...
                    W(
                        ...
                        function () {
                            d
                                ? (d = !1)
                                : (pa(a._zoomButton, { backgroundColor: a.toolbar.backgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }),
                    ...
                    W(
                        ...
                        function () {
                            d ||
                                (pa(a._zoomButton, { backgroundColor: a.toolbar.backgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                                0 >= navigator.userAgent.search("MSIE") && pa(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
                        },
                        this.allDOMEventHandlers
                    );
                }
                this._resetButton ||
                    ...
                    W(
                        ...
                        function () {
                            d ||
                                (pa(a._resetButton, { backgroundColor: a.toolbar.backgroundColorOnHover, color: a.toolbar.hoverFfontColorOnHoverontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                                0 >= navigator.userAgent.search("MSIE") && pa(a._resetButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
                        },
                        this.allDOMEventHandlers
                    ),
                    W(
                        ...
                        function () {
                            d ||
                                (pa(a._resetButton, { backgroundColor: a.toolbar.backgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                    ...
                    if ((a++, !this.options.data[c].type || 0 <= m._supportedChartTypes.indexOf(this.options.data[c].type))) {
                        ...
                        null === b.color
                            ? 1 < this.options.data.length
                                ? ((b._colorSet = [this._selectedColorSet[b.index % this._selectedColorSet.length]]), (b.color = this._selectedColorSet[b.index % this._selectedColorSet.length]))
                                : (b._colorSet =
                                      "line" === b.type ||
                                      "stepLine" === b.type ||
                                      "spline" === b.type ||
        ...
        m.prototype.setLayout = function () {
            ...
            c
                ? (Ka(this._zoomButton, this._resetButton),
                  ...
                  (this._zoomButton.style.borderRight = this.toolbar.borderThickness + "px solid " + this.toolbar.borderColor),
                  (this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor))
                : (ua(this._zoomButton, this._resetButton), (this._toolBar.style.border = this.toolbar.borderThickness + "px solid transparent"), this.options.zoomEnabled && ((this.zoomEnabled = !0), (this.panEnabled = !1)));
            eb(this);
            this._processData();
                            ...
                            for (var e = 0; e < c.length; e++)
                                (z = c[e]),
                                    1 > a && "undefined" !== typeof z.startTimePercent
                                        ? a >= z.startTimePercent && z.animationCallback(z.easingFunction(a - z.startTimePercent, 0, 1, 1 - z.startTimePercent), z)
                    ...
                    for (z = 0; z < u.dataPoints.length; z++) {
                        ...
                        if (0 < z) {
                            ...
                            null !== e &&
                                ...
                                (a.axisY.logarithmic
                                    ? ((B = e / u.dataPoints[z - 1].y), 1 > B && (B = 1 / B), d.minDiff > B && 1 !== B && (d.minDiff = B))
                                    : ((B = e - u.dataPoints[z - 1].y), 0 > B && (B *= -1), d.minDiff > B && 0 !== B && (d.minDiff = B)));
                        }
                        if (b < q && !h) null !== e && (n = b);
                        else {
                            if (!h && ((h = !0), 0 < z)) {
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    for (q = 0; q < n.dataPoints.length; q++) {
                        ...
                        if (0 < q) {
                            ...
                            null !== e &&
                                ...
                                (a.axisY.logarithmic
                                    ? 0 < e && ((m = e / n.dataPoints[q - 1].y), 1 > m && (m = 1 / m), d.minDiff > m && 1 !== m && (d.minDiff = m))
                                    : ((m = e - n.dataPoints[q - 1].y), 0 > m && (m *= -1), d.minDiff > m && 0 !== m && (d.minDiff = m)));
                        }
                        if (b < O && !g) null !== n.dataPoints[q].y && (k = b);
                            ...
                            if (b > t && !B) B = !0;
                            else if (b > t && B) continue;
                            n.dataPoints[q].label && (a.axisX.labels[b] = n.dataPoints[q].label);
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === n.dataPoints[q].y
                                ? c.viewPortMin === b && k < b && (c.viewPortMin = k)
                                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e), 0 <= e ? (l[b] ? (l[b] += e) : ((l[b] = e), (z = Math.min(e, z)))) : u[b] ? (u[b] += e) : ((u[b] = e), (h = Math.max(e, h))));
                        }
                    }
                    a.axisY.scaleBreaks &&
                        ...
                        (d.dataPointYPositiveSums
                            ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, l), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, u))
                            : ((d.dataPointYPositiveSums = l), (d.dataPointYNegativeSums = u)));
                ...
                for (q in l)
                    l.hasOwnProperty(q) &&
                        ...
                        a > d.max && (d.max = a),
                        q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, z)), a > d.viewPortMax && (d.viewPortMax = a)));
                for (q in u)
                    u.hasOwnProperty(q) &&
                        !isNaN(q) &&
                        ((a = u[q]),
                        ...
                        q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, h))));
            }
        };
        m.prototype._processStacked100PlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    for (n = 0; n < p.dataPoints.length; n++) {
                        ...
                        if (0 < n) {
                            ...
                            r(e) ||
                                ...
                                (a.axisY.logarithmic
                                    ? 0 < e && ((t = e / p.dataPoints[n - 1].y), 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t))
                                    : ((t = e - p.dataPoints[n - 1].y), 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t)));
                        }
                        if (b < k && !q) null !== e && (B = b);
                        else {
                            if (!q && ((q = !0), 0 < n)) {
                            ...
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e
                                ? c.viewPortMin === b && B < b && (c.viewPortMin = B)
                                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e), 0 <= e ? (l = !0) : 0 > e && (u = !0), (z[b] = z[b] ? z[b] + Math.abs(e) : Math.abs(e)));
                        }
                    }
                ...
                a.axisY.logarithmic
                    ...
                    : !l && u && ((d.max = r(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1)), (d.min = r(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)));
                d.viewPortMin = d.min;
                d.viewPortMax = d.max;
                a.dataPointYSums = z;
            }
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, u = !1, z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    for (p = 0; p < h.dataPoints.length; p++) {
                        ...
                        0 < p &&
                            (a.axisX.logarithmic
                                ? ((B = b / h.dataPoints[p - 1].x), 1 > B && (B = 1 / B), c.minDiff > B && 1 !== B && (c.minDiff = B))
                                : ((B = b - h.dataPoints[p - 1].x), 0 > B && (B *= -1), c.minDiff > B && 0 !== B && (c.minDiff = B)),
                            e &&
                                null !== e[0] &&
                                h.dataPoints[p - 1].y &&
                                null !== h.dataPoints[p - 1].y[0] &&
                                (a.axisY.logarithmic
                                    ? ((B = e[0] / h.dataPoints[p - 1].y[0]), 1 > B && (B = 1 / B), d.minDiff > B && 1 !== B && (d.minDiff = B))
                                    : ((B = e[0] - h.dataPoints[p - 1].y[0]), 0 > B && (B *= -1), d.minDiff > B && 0 !== B && (d.minDiff = B))));
                        if (!(b < m) || n) {
                            if (!n && ((n = !0), 0 < p)) {
                                p -= 2;
                                g = k;
        ...
        m.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if ((u.dataPoints[z].x && u.dataPoints[z].x.getTime) || "dateTime" === u.xValueType) f = !0;
                    for (z = 0; z < u.dataPoints.length; z++)
                        "undefined" !== typeof u.dataPoints[z].isCumulativeSum && !0 === u.dataPoints[z].isCumulativeSum
                            ? ((u.dataPointEOs[z].cumulativeSumYStartValue = 0), (u.dataPointEOs[z].cumulativeSum = 0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum), (u.dataPoints[z].y = 0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum))
                            : "undefined" !== typeof u.dataPoints[z].isIntermediateSum && !0 === u.dataPoints[z].isIntermediateSum
                            ? ((u.dataPointEOs[z].cumulativeSumYStartValue = n),
                              (u.dataPointEOs[z].cumulativeSum = 0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum),
                              (u.dataPoints[z].y = 0 === z ? 0 : b),
                              (n = 0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum),
                              (b = 0))
                            : ((e = "number" !== typeof u.dataPoints[z].y ? 0 : u.dataPoints[z].y),
                              (u.dataPointEOs[z].cumulativeSumYStartValue = 0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum),
                              (u.dataPointEOs[z].cumulativeSum = 0 === z ? e : u.dataPointEOs[z - 1].cumulativeSum + e),
                              (b += e));
                    for (z = 0; z < u.dataPoints.length; z++)
                        if (
                            ("undefined" === typeof u.dataPoints[z].x && (u.dataPoints[z].x = z + (a.axisX.logarithmic ? 1 : 0)),
                            ...
                            b < c.min && (c.min = b),
                            b > c.max && (c.max = b),
                            u.dataPointEOs[z].cumulativeSum < d.min && (d.min = u.dataPointEOs[z].cumulativeSum),
                            u.dataPointEOs[z].cumulativeSum > d.max && (d.max = u.dataPointEOs[z].cumulativeSum),
                            0 < z &&
                                (a.axisX.logarithmic
                                    ? ((n = b / u.dataPoints[z - 1].x), 1 > n && (n = 1 / n), c.minDiff > n && 1 !== n && (c.minDiff = n))
                                    : ((n = b - u.dataPoints[z - 1].x), 0 > n && (n *= -1), c.minDiff > n && 0 !== n && (c.minDiff = n)),
                                null !== e &&
                                    null !== u.dataPoints[z - 1].y &&
                                    (a.axisY.logarithmic
                                        ? ((e = u.dataPointEOs[z].cumulativeSum / u.dataPointEOs[z - 1].cumulativeSum), 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e))
                                        : ((e = u.dataPointEOs[z].cumulativeSum - u.dataPointEOs[z - 1].cumulativeSum), 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))),
                            !(b < q) || h)
                        ) {
                            if (!h && ((h = !0), 0 < z)) {
                                z -= 2;
                            ...
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < z &&
                                (u.dataPointEOs[z - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = u.dataPointEOs[z - 1].cumulativeSum),
                                u.dataPointEOs[z - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = u.dataPointEOs[z - 1].cumulativeSum));
        ...
        m.prototype.calculateAutoBreaks = function () {
                        ...
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, l = f.max, p = d.min, q = d.max, f = f._dataRanges, d = d._dataRanges, n, u = 0, z = 0; z < a.dataSeriesIndexes.length; z++) {
                            ...
                            if (!(4 > k.dataPoints.length))
                                for (u = 0; u < k.dataPoints.length; u++)
                                    if (
                                        (b &&
                                            ((n = ((l + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                                            (g = k.dataPoints[u].x.getTime ? k.dataPoints[u].x.getTime() : k.dataPoints[u].x),
                                            (n = Math.floor((g - h) / n)),
                                            g < f[n].min && (f[n].min = g),
                                            g > f[n].max && (f[n].max = g)),
                                        c)
                                        ...
                                        if ((g = "waterfall" === a.type ? k.dataPointEOs[u].cumulativeSum : k.dataPoints[u].y) && g.length)
                                            for (var s = 0; s < g.length; s++) (n = Math.floor((g[s] - p) / m)), g[s] < d[n].min && (d[n].min = g[s]), g[s] > d[n].max && (d[n].max = g[s]);
                        ...
                        if (!(4 > p.dataPoints.length))
                            for (h = 0; h < p.dataPoints.length; h++)
                                (g = ((d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                                    (b = p.dataPoints[h].x.getTime ? p.dataPoints[h].x.getTime() : p.dataPoints[h].x),
                                    (g = Math.floor((b - c) / g)),
                                    b < f[g].min && (f[g].min = b),
                                    b > f[g].max && (f[g].max = b);
                    }
            ...
            for (var b, e = this, f = !1, l = 0; l < this._axes.length; l++)
                if (this._axes[l].scaleBreaks && this._axes[l].scaleBreaks.autoCalculate && 1 <= this._axes[l].scaleBreaks.maxNumberOfAutoBreaks) {
                    ...
                    for (var u = 0; u < 100 / Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10); u++) this._axes[l].dataInfo._dataRanges.push({ min: Infinity, max: -Infinity });
                }
            if (f) {
                ...
                for (l = 0; l < this._axes.length; l++)
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        if (this._axes[l].scaleBreaks.customBreaks)
                            for (u = 0; u < this._axes[l].scaleBreaks.customBreaks.length; u++)
                                for (b = 0; b < f.length; b++)
                                    if (
                                        (this._axes[l].scaleBreaks.customBreaks[u].startValue <= f[b].start && f[b].start <= this._axes[l].scaleBreaks.customBreaks[u].endValue) ||
                                        (this._axes[l].scaleBreaks.customBreaks[u].startValue <= f[b].start && f[b].start <= this._axes[l].scaleBreaks.customBreaks[u].endValue) ||
                                        (f[b].start <= this._axes[l].scaleBreaks.customBreaks[u].startValue && this._axes[l].scaleBreaks.customBreaks[u].startValue <= f[b].end) ||
                                        (f[b].start <= this._axes[l].scaleBreaks.customBreaks[u].endValue && this._axes[l].scaleBreaks.customBreaks[u].endValue <= f[b].end)
                                    )
                                        f.splice(b, 1), b--;
                        f.sort(function (a, b) {
                        ...
                        for (u = 0; u < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); u++)
                            (b = a(f[u].start, f[u].end, this._axes[l].logarithmic ? this._axes[l].dataInfo.max / this._axes[l].dataInfo.min : this._axes[l].dataInfo.max - this._axes[l].dataInfo.min, this._axes[l].logarithmic)),
                                this._axes[l].scaleBreaks.autoBreaks.push(new V(this, "autoBreaks", b, u, ++this._eventManager.lastObjectId, this._axes[l].scaleBreaks)),
        ...
        m.prototype._mouseEventHandler = function (a) {
            ...
            m.capturedEventParam &&
                ...
                b.hasOwnProperty(c) &&
                    ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture ? (a.target !== b.chart.overlaidCanvas && s) || b[c].call(b.context, d.x, d.y) : a.target !== b.chart.overlaidCanvas && (b.chart.isDrag = !1)));
            ...
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                    if (this.panEnabled)
                        ...
                        this.validateRegion(b, u, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid &&
        ...
        m.prototype.validateRegion = function (a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), u = !1, z = [], h = [], p = [], n = 0; n < this._axes.length; n++)
                (("axisX" === this._axes[n].type && f) || ("axisY" === this._axes[n].type && l)) && h.push(this._axes[n]);
            for (l = 0; l < h.length; l++) {
                ...
                if (isFinite(n.dataInfo.minDiff))
                    if (
                        ((B = n.getApparentDifference(q, g, null, !0)),
                        !(
                            f ||
                            (!(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && ((n.logarithmic && B < Math.pow(n.dataInfo.minDiff, 3)) || (!n.logarithmic && B < 3 * Math.abs(n.dataInfo.minDiff)))) ||
                            q < n.minimum ||
                            g > n.maximum
                        ))
                    )
        ...
        m.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var l = ma("indexLabelFontWeight", h.dataPoint, h.dataSeries),
                    ...
                    B = ma("indexLabelLineDashType", h.dataPoint, h.dataSeries),
                ...
                var A = h.dataPoint.indexLabelFormatter
                    ? h.dataPoint.indexLabelFormatter(x)
                    : h.dataPoint.indexLabel
                    ? this.replaceKeywordsWithValue(h.dataPoint.indexLabel, h.dataPoint, h.dataSeries, null, h.indexKeyword)
                    : h.dataSeries.indexLabelFormatter
                    ? h.dataSeries.indexLabelFormatter(x)
                    : h.dataSeries.indexLabel
                    ? this.replaceKeywordsWithValue(h.dataSeries.indexLabel, h.dataPoint, h.dataSeries, null, h.indexKeyword)
                    : null;
                if (null !== A && "" !== A) {
                    var t = ma("indexLabelPlacement", h.dataPoint, h.dataSeries),
                        x = ma("indexLabelOrientation", h.dataPoint, h.dataSeries),
                        J = h.direction,
                        C = h.dataSeries.axisX,
                    ...
                    if ("stackedarea100" === p) {
                        ...
                        if (h.dataPoint.x < C.viewportMinimum || h.dataPoint.x > C.viewportMaximum || h.dataPoint.y < y.viewportMinimum || h.dataPoint.y > y.viewportMaximum) continue;
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== t
                            ? ((e = c.y1),
                              (f = c.y2),
                              0 < J
                                  ? ((q = h.point.y - z / 2 - l - b), q < e && ((q = "auto" === t ? Math.max(h.point.y, e) + l + b : e + l + b), (v = q + z > h.point.y)))
                                  : ((q = h.point.y + z / 2 + l + b), q > f - z - l - b && ((q = "auto" === t ? Math.min(h.point.y, f) - z - l - b : f - z - l - b), (v = q < h.point.y))))
                            : ((e = Math.max(h.bounds.y1, c.y1)),
                              (f = Math.min(h.bounds.y2, c.y2)),
                              (b = 0 <= p.indexOf("range") || "error" === p ? (0 < J ? Math.max(h.bounds.y1, c.y1) + z / 2 + l : Math.min(h.bounds.y2, c.y2) - z / 2 - l) : (Math.max(h.bounds.y1, c.y1) + Math.min(h.bounds.y2, c.y2)) / 2),
                              0 < J
                                  ? ((q = Math.max(h.point.y, b)), q < e && ("bubble" === p || "scatter" === p) && (q = Math.max(h.point.y - z - l, c.y1 + l)))
                                  : ((q = Math.min(h.point.y, b)), q > f - z - l && ("bubble" === p || "scatter" === p) && (q = Math.min(h.point.y + l, c.y2 - z - l))),
                              (q = Math.min(q, f)));
                    } else
                        0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? ((t = "auto"), (e = 4)) : 0 <= p.indexOf("stacked") ? "auto" === t && (t = "inside") : "bubble" === p && (t = "inside"),
                            (q = h.point.y),
                            "inside" !== t
                                ? ((l = c.x1),
                                  (f = c.x2),
                                  0 > J
                                      ? ((n = h.point.x - u - e - b), n < l && ((n = "auto" === t ? Math.max(h.point.x, l) + e + b : l + e + b), (v = n + u > h.point.x)))
                                      : ((n = h.point.x + e + b), n > f - u - e - b && ((n = "auto" === t ? Math.min(h.point.x, f) - u - e - b : f - u - e - b), (v = n < h.point.x))))
                                : ((l = Math.max(h.bounds.x1, c.x1)),
                                  Math.min(h.bounds.x2, c.x2),
                                  (b =
                                      0 <= p.indexOf("range") || "error" === p ? (0 > J ? Math.max(h.bounds.x1, c.x1) + u / 2 + e : Math.min(h.bounds.x2, c.x2) - u / 2 - e) : (Math.max(h.bounds.x1, c.x1) + Math.min(h.bounds.x2, c.x2)) / 2),
                                  (n = 0 > J ? Math.max(h.point.x, b) - u / 2 : Math.min(h.point.x, b) - u / 2),
                                  (n = Math.max(n, l)));
                    "vertical" === x && (q += z);
                    g.x = n;
                    g.y = q;
                    ...
                    m &&
                        "inside" !== t &&
                        ((0 > p.indexOf("bar") && ("error" !== p || !h.axisSwapped) && h.point.x > c.x1 && h.point.x < c.x2) || !v) &&
                        ((0 > p.indexOf("column") && ("error" !== p || h.axisSwapped) && h.point.y > c.y1 && h.point.y < c.y2) || !v) &&
                        ((d.lineWidth = m),
                        (d.strokeStyle = k ? k : "gray"),
                        d.setLineDash && d.setLineDash(Q(B, m)),
                        d.beginPath(),
                        d.moveTo(h.point.x, h.point.y),
                        0 <= p.indexOf("bar") || ("error" === p && h.axisSwapped)
                            ? d.lineTo(n + (0 < h.direction ? 0 : u), q + ("horizontal" === x ? z : -z) / 2)
                            : 0 <= p.indexOf("column") || ("error" === p && !h.axisSwapped)
                            ? d.lineTo(n + u / 2, q + ((0 < h.direction ? z : -z) + ("horizontal" === x ? z : -z)) / 2)
                            : d.lineTo(n + u / 2, q + ((q < h.point.y ? z : -z) + ("horizontal" === x ? z : -z)) / 2),
                        d.stroke());
                }
            }
                ...
                for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < p.length) {
                        for (var J = !1, t = 0; t < p.length; t++)
                            if (((x = p[t].x.getTime ? p[t].x.getTime() : p[t].x), !(x < a.axisX.dataInfo.viewPortMin || (x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !J)))))
                                if ("number" !== typeof p[t].y) 0 < t && !(h.connectNullData || J || m) && (c.stroke(), s && b.stroke()), (J = !0);
                                    ...
                                    this._eventManager.objectMap[C] = { id: C, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: t, x1: x, y1: r };
                                    m || J
                                        ? (!m && h.connectNullData
                                              ? (c.setLineDash &&
                                                    (h.options.nullDataLineDashType || (n === h.lineDashType && h.lineDashType !== h.nullDataLineDashType)) &&
                                                    (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), (n = h.nullDataLineDashType), c.setLineDash(q)),
                                                c.lineTo(x, r),
                                                s && b.lineTo(x, r))
                                              : (c.beginPath(), c.moveTo(x, r), s && (b.beginPath(), b.moveTo(x, r))),
                                          (J = m = !1))
                                        : (c.lineTo(x, r), s && b.lineTo(x, r), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, r), s && (b.stroke(), b.beginPath(), b.moveTo(x, r))));
                                    l = { x: x, y: r };
                                    t < p.length - 1 &&
                                        (k !== (p[t].lineColor || B) || n !== (p[t].lineDashType || h.lineDashType)) &&
                                        (c.stroke(),
                                        c.beginPath(),
                                        c.moveTo(x, r),
                                        (k = p[t].lineColor || B),
                                        (c.strokeStyle = k),
                                        c.setLineDash && (p[t].lineDashType ? ((n = p[t].lineDashType), c.setLineDash(Q(n, h.lineThickness))) : ((n = h.lineDashType), c.setLineDash(g))));
                                    if (0 < p[t].markerSize || 0 < h.markerSize) {
                                        var y = h.getMarkerProperties(t, x, r, c);
                                        f.push(y);
                                        C = S(C);
                                        s && f.push({ x: x, y: r, ctx: b, type: y.type, size: y.size, color: C, borderColor: C, borderThickness: y.borderThickness });
                                    }
                                    (p[t].indexLabel || h.indexLabel || p[t].indexLabelFormatter || h.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "line", dataPoint: p[t], dataSeries: h, point: { x: x, y: r }, direction: 0 > p[t].y === a.axisY.reversed ? 1 : -1, color: B });
                                }
                        c.stroke();
                        s && b.stroke();
                    }
        ...
        m.prototype.renderStepLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < p.length) {
                        for (var J = !1, t = 0; t < p.length; t++)
                            if (((x = p[t].getTime ? p[t].x.getTime() : p[t].x), !(x < a.axisX.dataInfo.viewPortMin || (x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !J)))))
                                if ("number" !== typeof p[t].y) 0 < t && !(h.connectNullData || J || m) && (c.stroke(), s && b.stroke()), (J = !0);
                                else {
                                    var C = r;
                                    x = a.axisX.convertValueToPixel(x);
                                    ...
                                    this._eventManager.objectMap[y] = { id: y, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: t, x1: x, y1: r };
                                    m || J
                                        ? (!m && h.connectNullData
                                              ? (c.setLineDash &&
                                                    (h.options.nullDataLineDashType || (n === h.lineDashType && h.lineDashType !== h.nullDataLineDashType)) &&
                                                ...
                                                c.lineTo(x, C),
                                                c.lineTo(x, r),
                                                s && (b.lineTo(x, C), b.lineTo(x, r)))
                                              : (c.beginPath(), c.moveTo(x, r), s && (b.beginPath(), b.moveTo(x, r))),
                                          (J = m = !1))
                                        : (c.lineTo(x, C), s && b.lineTo(x, C), c.lineTo(x, r), s && b.lineTo(x, r), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, r), s && (b.stroke(), b.beginPath(), b.moveTo(x, r))));
                                    l = { x: x, y: r };
                                    t < p.length - 1 &&
                                        (k !== (p[t].lineColor || B) || n !== (p[t].lineDashType || h.lineDashType)) &&
                                        (c.stroke(),
                                        ...
                                        c.setLineDash && (p[t].lineDashType ? ((n = p[t].lineDashType), c.setLineDash(Q(n, h.lineThickness))) : ((n = h.lineDashType), c.setLineDash(g))));
                                    if (0 < p[t].markerSize || 0 < h.markerSize)
                                        (C = h.getMarkerProperties(t, x, r, c)), f.push(C), (y = S(y)), s && f.push({ x: x, y: r, ctx: b, type: C.type, size: C.size, color: y, borderColor: y, borderThickness: C.borderThickness });
                                    (p[t].indexLabel || h.indexLabel || p[t].indexLabelFormatter || h.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stepLine", dataPoint: p[t], dataSeries: h, point: { x: x, y: r }, direction: 0 > p[t].y === a.axisY.reversed ? 1 : -1, color: B });
                                }
                        c.stroke();
                        s && b.stroke();
                    }
                ...
                if (0 < a.length) {
                    ...
                    for (var c = 0; c < a.length - 3; c += 3)
                        if (
                            ...
                            s && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y),
                            ...
                            b.stroke(),
                                ...
                                s && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y));
                    b.stroke();
                    s && e.stroke();
                }
            }
                            ...
                            if (((t = p[m].getTime ? p[m].x.getTime() : p[m].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x)))))
                                if ("number" !== typeof p[m].y)
                                    0 < m &&
                                        !x &&
                                        (h.connectNullData
                                            ? b.setLineDash && 0 < r.length && (h.options.nullDataLineDashType || !p[m - 1].lineDashType) && ((r[r.length - 1].newLineDashArray = q), (n = h.nullDataLineDashType))
                                            : (d(r), (r = []))),
                                        (x = !0);
                                else {
                                    ...
                                    this._eventManager.objectMap[J] = { id: J, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: m, x1: t, y1: x };
                                    r[r.length] = { x: t, y: x };
                                    m < p.length - 1 &&
                                        (k !== (p[m].lineColor || B) || n !== (p[m].lineDashType || h.lineDashType)) &&
                                        ((k = p[m].lineColor || B),
                                        (r[r.length - 1].newStrokeStyle = k),
                                        b.setLineDash && (p[m].lineDashType ? ((n = p[m].lineDashType), (r[r.length - 1].newLineDashArray = Q(n, h.lineThickness))) : ((n = h.lineDashType), (r[r.length - 1].newLineDashArray = g))));
                                    if (0 < p[m].markerSize || 0 < h.markerSize) {
                                        var C = h.getMarkerProperties(m, t, x, b);
                                        l.push(C);
                                        J = S(J);
                                        s && l.push({ x: t, y: x, ctx: e, type: C.type, size: C.size, color: J, borderColor: J, borderThickness: C.borderThickness });
                                    }
                                    (p[m].indexLabel || h.indexLabel || p[m].indexLabelFormatter || h.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "spline", dataPoint: p[m], dataSeries: h, point: { x: t, y: x }, direction: 0 > p[m].y === a.axisY.reversed ? 1 : -1, color: B });
                                    x = !1;
                                }
                    d(r);
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q = a.dataSeriesIndexes[p],
                        ...
                        B = g.dataPoints;
                    if (0 < B.length)
                        for (var k = 5 < n && g.bevelEnabled ? !0 : !1, f = 0; f < B.length; f++)
                            if ((B[f].getTime ? (z = B[f].x.getTime()) : (z = B[f].x), !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax) && "number" === typeof B[f].y)) {
                                ...
                                da(c, l, u, m, t, b, 0, null, k && 0 <= B[f].y, 0 > B[f].y && k, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: u, x2: m, y2: t };
                                b = S(b);
                                s && da(this._eventManager.ghostCtx, l, u, m, t, b, 0, null, !1, !1, !1, !1);
                                (B[f].indexLabel || g.indexLabel || B[f].indexLabelFormatter || g.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        bounds: { x1: l, y1: Math.min(u, t), x2: m, y2: Math.max(u, t) },
                                        color: b,
                                    });
                            }
                }
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (((b = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                                ...
                                var A = (p - (a.plotType.plotUnits.length * g) / 2 + a.index * g) << 0,
                                    J = (A + g) << 0,
                                    C;
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y))
                                    (u[b] = t[h].y + (u[b] ? u[b] : 0)), 0 < u[b] && ((n = a.axisY.convertValueToPixel(u[b])), (C = "undefined" !== typeof f[b] ? f[b] : q), (f[b] = n));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y)
                                    (z[b] = t[h].y + (z[b] ? z[b] : 0)), (C = a.axisY.convertValueToPixel(z[b])), (n = "undefined" !== typeof l[b] ? l[b] : q), (l[b] = C);
                                ...
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: A, y1: n, x2: J, y2: C };
                                b = S(b);
                        ...
                        for (var r = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++)
                            if (((b = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y)) {
                                    ...
                                    (z[b] = n + ("undefined" !== typeof z[b] ? z[b] : 0)), (C = a.axisY.convertValueToPixel(z[b])), (n = l[b] ? l[b] : q), (l[b] = C);
                                    ...
                                    f[b] = y + (C - n);
                                } else (y = "undefined" !== typeof l[b] ? l[b] : 0), (C = n + y), (n = q + y), a.dataSeriesIndexes.length - 1 === B && 1 >= Math.abs(e.y2 - C) && (C = e.y2), (l[b] = y + (C - n));
                                b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length];
                                da(c, A, n, J, C, b, 0, null, r && 0 <= t[h].y, 0 > t[h].y && r, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: A, y1: n, x2: J, y2: C };
                    ...
                    if (0 < B.length) {
                        ...
                        for (f = 0; f < B.length; f++)
                            if ((B[f].getTime ? (z = B[f].x.getTime()) : (z = B[f].x), !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax) && "number" === typeof B[f].y)) {
                                ...
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: t, y1: u, x2: l, y2: m };
                                b = S(b);
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (((b = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                                ...
                                var A = (n - (a.plotType.plotUnits.length * g) / 2 + a.index * g) << 0,
                                    J = (A + g) << 0,
                                    C;
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y))
                                    (u[b] = t[h].y + (u[b] ? u[b] : 0)), 0 < u[b] && ((C = f[b] ? f[b] : q), (f[b] = p = a.axisY.convertValueToPixel(u[b])));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) (z[b] = t[h].y + (z[b] ? z[b] : 0)), (p = l[b] ? l[b] : q), (l[b] = C = a.axisY.convertValueToPixel(z[b]));
                                ...
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: C, y1: A, x2: p, y2: J };
                                b = S(b);
                                s && da(this._eventManager.ghostCtx, C, A, p, J, b, 0, null, !1, !1, !1, !1);
                                (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) &&
                                    this._indexLabels.push({
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (((b = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                                ...
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) (z[b] = A + (z[b] ? z[b] : 0)), (p = l[b] ? l[b] : q), (l[b] = A = a.axisY.convertValueToPixel(z[b]));
                                else if (((p = a.axisY.convertValueToPixel(A)), 0 <= t[h].y)) {
                                    var y = f[b] ? f[b] : 0;
                                    A = q + y;
                                    p += y;
                                ...
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: A, y1: J, x2: p, y2: C };
                                b = S(b);
        ...
        m.prototype.renderArea = function (a) {
            ...
            function b() {
                C &&
                    ...
                    a.axisY.logarithmic || (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum) ? (J = A) : 0 > a.axisY.viewportMaximum ? (J = u.y1) : 0 < a.axisY.viewportMinimum && (J = A),
                    f.lineTo(m, J),
                    f.lineTo(C.x, J),
                    f.closePath(),
                    ...
                    f.fill(),
                    (f.globalAlpha = 1),
                    s && (l.lineTo(m, J), l.lineTo(C.x, J), l.closePath(), l.fill()),
                    f.beginPath(),
                    f.moveTo(m, t),
                    l.beginPath(),
                    l.moveTo(m, t),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < B.length) {
                        ...
                        for (var ha = !0; k < B.length; k++)
                            if (((r = B[k].x.getTime ? B[k].x.getTime() : B[k].x), !(r < a.axisX.dataInfo.viewPortMin || (r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ha)))))
                                if ("number" !== typeof B[k].y) g.connectNullData || ha || d || b(), (ha = !0);
                                else {
                                    ...
                                    d || ha
                                        ? (!d && g.connectNullData
                                              ? (f.setLineDash &&
                                                    ...
                                                    ((d = m), (c = t), (m = p.x), (t = p.y), b(), f.moveTo(p.x, p.y), (m = d), (t = c), (C = p), (c = g.nullDataLineDashType), f.setLineDash(K)),
                                                f.lineTo(m, t),
                                                s && l.lineTo(m, t))
                                              : (f.beginPath(), f.moveTo(m, t), s && (l.beginPath(), l.moveTo(m, t)), (C = { x: m, y: t })),
                                          (ha = d = !1))
                                        : (f.lineTo(m, t), s && l.lineTo(m, t), 0 == k % 250 && b());
                                    p = { x: m, y: t };
                                    k < B.length - 1 &&
                                        (w !== (B[k].lineColor || v) || c !== (B[k].lineDashType || g.lineDashType)) &&
                                        (b(),
                                        (w = B[k].lineColor || v),
                                        (f.strokeStyle = w),
                                        f.setLineDash && (B[k].lineDashType ? ((c = B[k].lineDashType), f.setLineDash(Q(c, g.lineThickness))) : ((c = g.lineDashType), f.setLineDash(P))));
                                    var $ = g.dataPointIds[k];
                                    this._eventManager.objectMap[$] = { id: $, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: k, x1: m, y1: t };
                                    0 !== B[k].markerSize &&
                                        (0 < B[k].markerSize || 0 < g.markerSize) &&
                                        ((r = g.getMarkerProperties(k, m, t, f)), z.push(r), ($ = S($)), s && z.push({ x: m, y: t, ctx: l, type: r.type, size: r.size, color: $, borderColor: $, borderThickness: r.borderThickness }));
                                    (B[k].indexLabel || g.indexLabel || B[k].indexLabelFormatter || g.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "area", dataPoint: B[k], dataSeries: g, point: { x: m, y: t }, direction: 0 > B[k].y === a.axisY.reversed ? 1 : -1, color: y });
                                }
                        b();
                        Y.drawMarkers(z);
                    }
                    ...
                    if (0 < p.lineThickness) {
                        ...
                        for (var d = 0; d < c.length - 3; d += 3)
                            if (
                                ...
                                s && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    var l = [],
                        ...
                        r = [];
                    if (0 < n.length) {
                        var A = p._colorSet[q % p._colorSet.length],
                            J = (p.lineColor = p.options.lineColor || A),
                            C = J;
                        b.fillStyle = A;
                        b.strokeStyle = J;
                        ...
                        for (B = !1; q < n.length; q++)
                            if (((g = n[q].x.getTime ? n[q].x.getTime() : n[q].x), !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !B)))))
                                if ("number" !== typeof n[q].y)
                                    0 < q &&
                                        !B &&
                                        (p.connectNullData
                                            ? b.setLineDash && 0 < r.length && (p.options.nullDataLineDashType || !n[q - 1].lineDashType) && ((r[r.length - 1].newLineDashArray = w), (y = p.nullDataLineDashType))
                                            : (d(), (r = []))),
                                        (B = !0);
                                else {
                                    ...
                                    this._eventManager.objectMap[K] = { id: K, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: q, x1: g, y1: B };
                                    r[r.length] = { x: g, y: B };
                                    q < n.length - 1 &&
                                        (C !== (n[q].lineColor || J) || y !== (n[q].lineDashType || p.lineDashType)) &&
                                        ((C = n[q].lineColor || J),
                                        (r[r.length - 1].newStrokeStyle = C),
                                        b.setLineDash && (n[q].lineDashType ? ((y = n[q].lineDashType), (r[r.length - 1].newLineDashArray = Q(y, p.lineThickness))) : ((y = p.lineDashType), (r[r.length - 1].newLineDashArray = D))));
                                    if (0 !== n[q].markerSize && (0 < n[q].markerSize || 0 < p.markerSize)) {
                                        var P = p.getMarkerProperties(q, g, B, b);
                                        l.push(P);
                                        K = S(K);
                                        s && l.push({ x: g, y: B, ctx: e, type: P.type, size: P.size, color: K, borderColor: K, borderThickness: P.borderThickness });
                                    }
                                    (n[q].indexLabel || p.indexLabel || n[q].indexLabelFormatter || p.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "splineArea", dataPoint: n[q], dataSeries: p, point: { x: g, y: B }, direction: 0 > n[q].y === a.axisY.reversed ? 1 : -1, color: A });
                                    B = !1;
                                }
                        d();
                        Y.drawMarkers(l);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < B.length) {
                        ...
                        for (; k < B.length; k++)
                            if (((r = B[k].x.getTime ? B[k].x.getTime() : B[k].x), !(r < a.axisX.dataInfo.viewPortMin || (r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))))) {
                                var $ = t;
                                "number" !== typeof B[k].y
                                      ...
                                      d || c
                                          ? (!d && g.connectNullData
                                                ? (f.setLineDash &&
                                                      ...
                                                      ((d = m), (c = t), (m = p.x), (t = p.y), b(), f.moveTo(p.x, p.y), (m = d), (t = c), (C = p), (K = g.nullDataLineDashType), f.setLineDash(P)),
                                                  f.lineTo(m, $),
                                                  f.lineTo(m, t),
                                                  s && (l.lineTo(m, $), l.lineTo(m, t)))
                                                : (f.beginPath(), f.moveTo(m, t), s && (l.beginPath(), l.moveTo(m, t)), (C = { x: m, y: t })),
                                            (c = d = !1))
                                          : (f.lineTo(m, $), s && l.lineTo(m, $), f.lineTo(m, t), s && l.lineTo(m, t), 0 == k % 250 && b()),
                                      (p = { x: m, y: t }),
                                      k < B.length - 1 &&
                                          (w !== (B[k].lineColor || v) || K !== (B[k].lineDashType || g.lineDashType)) &&
                                          (b(),
                                          (w = B[k].lineColor || v),
                                          (f.strokeStyle = w),
                                          f.setLineDash && (B[k].lineDashType ? ((K = B[k].lineDashType), f.setLineDash(Q(K, g.lineThickness))) : ((K = g.lineDashType), f.setLineDash(D)))),
                                      (r = g.dataPointIds[k]),
                                      (this._eventManager.objectMap[r] = { id: r, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: k, x1: m, y1: t }),
                                      0 !== B[k].markerSize &&
                                          (0 < B[k].markerSize || 0 < g.markerSize) &&
                                          (($ = g.getMarkerProperties(k, m, t, f)), z.push($), (r = S(r)), s && z.push({ x: m, y: t, ctx: l, type: $.type, size: $.size, color: r, borderColor: r, borderThickness: $.borderThickness })),
                                      (B[k].indexLabel || g.indexLabel || B[k].indexLabelFormatter || g.indexLabelFormatter) &&
                                          this._indexLabels.push({ chartType: "stepArea", dataPoint: B[k], dataSeries: g, point: { x: m, y: t }, direction: 0 > B[k].y === a.axisY.reversed ? 1 : -1, color: y }));
                            }
                        b();
                        Y.drawMarkers(z);
                    }
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !$))))
                                if ("number" !== typeof ia.y) y.connectNullData || $ || x || d(), ($ = !0);
                                    ...
                                    x || $
                                        ? (!x && y.connectNullData
                                              ? (b.setLineDash &&
                                                    (y.options.nullDataLineDashType || (A === y.lineDashType && y.lineDashType !== y.nullDataLineDashType)) &&
                                                    ((x = h.pop()), (A = h[h.length - 1]), d(), b.moveTo(t.x, t.y), h.push(A), h.push(x), (A = y.nullDataLineDashType), b.setLineDash(P)),
                                                b.lineTo(g, k),
                                                s && r.lineTo(g, k))
                                              : (b.beginPath(), b.moveTo(g, k), s && (r.beginPath(), r.moveTo(g, k))),
                                          ($ = x = !1))
                                        : (b.lineTo(g, k), s && r.lineTo(g, k), 0 == q % 250 && (d(), b.moveTo(g, k), s && r.moveTo(g, k), h.push({ x: g, y: m - na })));
                                    t = { x: g, y: k };
                                    q < v.length - 1 &&
                                        (K !== (v[q].lineColor || w) || A !== (v[q].lineDashType || y.lineDashType)) &&
                                        (d(),
                                        b.beginPath(),
                                        b.moveTo(g, k),
                                        h.push({ x: g, y: m - na }),
                                        (K = v[q].lineColor || w),
                                        (b.strokeStyle = K),
                                        b.setLineDash && (v[q].lineDashType ? ((A = v[q].lineDashType), b.setLineDash(Q(A, y.lineThickness))) : ((A = y.lineDashType), b.setLineDash(D))));
                                    ...
                                    0 <= y.dataPointIndexes[f] &&
                                        ...
                                        ((na = y.getMarkerProperties(y.dataPointIndexes[f], g, k, b)),
                                        l.push(na),
                                        (f = S(E)),
                                        s && l.push({ x: g, y: k, ctx: r, type: na.type, size: na.size, color: f, borderColor: f, borderThickness: na.borderThickness }));
                                    (ia.indexLabel || y.indexLabel || ia.indexLabelFormatter || y.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea", dataPoint: ia, dataSeries: y, point: { x: g, y: k }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        b.moveTo(g, k);
                ...
                for (v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < p.length) {
                        ...
                        for (var $ = !0, q = 0; q < p.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !$))))
                                if ("number" !== typeof ia.y) y.connectNullData || $ || O || d(), ($ = !0);
                                else {
                                    var na;
                                    ...
                                    O || $
                                        ? (!O && y.connectNullData
                                              ? (b.setLineDash &&
                                                    (y.options.nullDataLineDashType || (t === y.lineDashType && y.lineDashType !== y.nullDataLineDashType)) &&
                                                    ((O = h.pop()), (t = h[h.length - 1]), d(), b.moveTo(r.x, r.y), h.push(t), h.push(O), (t = y.nullDataLineDashType), b.setLineDash(P)),
                                                b.lineTo(g, m),
                                                s && A.lineTo(g, m))
                                              : (b.beginPath(), b.moveTo(g, m), s && (A.beginPath(), A.moveTo(g, m))),
                                          ($ = O = !1))
                                        : (b.lineTo(g, m), s && A.lineTo(g, m), 0 == q % 250 && (d(), b.moveTo(g, m), s && A.moveTo(g, m), h.push({ x: g, y: x - ca })));
                                    r = { x: g, y: m };
                                    q < w.length - 1 &&
                                        (K !== (w[q].lineColor || D) || t !== (w[q].lineDashType || y.lineDashType)) &&
                                        (d(),
                                        b.beginPath(),
                                        b.moveTo(g, m),
                                        h.push({ x: g, y: x - ca }),
                                        (K = w[q].lineColor || D),
                                        (b.strokeStyle = K),
                                        b.setLineDash && (w[q].lineDashType ? ((t = w[q].lineDashType), b.setLineDash(Q(t, y.lineThickness))) : ((t = y.lineDashType), b.setLineDash(E))));
                                    if (0 <= y.dataPointIndexes[f]) {
                                        var F = y.dataPointIds[y.dataPointIndexes[f]];
                                        this._eventManager.objectMap[F] = { id: F, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: y.dataPointIndexes[f], x1: g, y1: m };
                                    }
                                    0 <= y.dataPointIndexes[f] &&
                                        0 !== ia.markerSize &&
                                        (0 < ia.markerSize || 0 < y.markerSize) &&
                                        ((ca = y.getMarkerProperties(q, g, m, b)), u.push(ca), (f = S(F)), s && u.push({ x: g, y: m, ctx: A, type: ca.type, size: ca.size, color: f, borderColor: f, borderThickness: ca.borderThickness }));
                                    (ia.indexLabel || y.indexLabel || ia.indexLabelFormatter || y.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea100", dataPoint: ia, dataSeries: y, point: { x: g, y: m }, direction: 0 > w[q].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        b.moveTo(g, m);
        ...
        m.prototype.renderBubble = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var u = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)
                    for (var p = a.dataSeriesIndexes[h], n = this.data[p], q = n.dataPoints, g = 0, e = 0; e < q.length; e++)
                        (f = q[e].getTime ? (f = q[e].x.getTime()) : (f = q[e].x)), f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || ((g = q[e].z), g > u && (u = g), g < k && (k = g));
                    ...
                    if (((p = a.dataSeriesIndexes[h]), (n = this.data[p]), (q = n.dataPoints), 0 < q.length))
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (((f = q[e].getTime ? (f = q[e].x.getTime()) : (f = q[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y)) {
                                ...
                                this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: e, x1: f, y1: l, size: O };
                                O = S(t);
                    ...
                    if (0 < p.length) {
                        ...
                        for (var n = 0, q = 0, e = 0; e < p.length; e++)
                            if (((f = p[e].getTime ? (f = p[e].x.getTime()) : (f = p[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[e].y)) {
                                ...
                                c.globalAlpha = 1;
                                (Math.sqrt((n - f) * (n - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && p.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                                    ((n = h.dataPointIds[e]),
                                    (this._eventManager.objectMap[n] = { id: n, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: e, x1: f, y1: l }),
                                    (n = S(n)),
                                    s && Y.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, n, n, g.borderThickness),
                                    (p[e].indexLabel || h.indexLabel || p[e].indexLabelFormatter || h.indexLabelFormatter) &&
                                        this._indexLabels.push({
                                            chartType: "scatter",
                                            dataPoint: p[e],
                                            dataSeries: h,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var ga = 0; ga < a.dataSeriesIndexes.length; ga++) {
                    var O = a.dataSeriesIndexes[ga],
                        ...
                        x = t.dataPoints;
                    if (0 < x.length)
                        for (var A = 5 < m && t.bevelEnabled ? !0 : !1, u = 0; u < x.length; u++)
                            if (
                                ...
                                var v = (k - m / 2) << 0,
                                    ...
                                    w = 0 === y % 2 ? 0 : 0.5,
                                    D = t.dataPointIds[u];
                                this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: O, dataPointIndex: u, x1: v, y1: h, x2: C, y2: p, x3: k, y3: n, x4: k, y4: q, borderThickness: y, color: e };
                                c.strokeStyle = e;
                                c.beginPath();
                                c.lineWidth = y;
                                ...
                                "candlestick" === t.type
                                    ? (c.moveTo(k - w, p),
                                      ...
                                      c.lineTo(k - w, n),
                                      c.stroke(),
                                      da(c, v, Math.min(h, q), C, Math.max(h, q), x[u].y[0] <= x[u].y[3] ? t.risingColor : f, y, e, A, A, !1, !1, t.fillOpacity),
                                      s &&
                                          ((e = S(D)),
                                          (b.strokeStyle = e),
                                          b.moveTo(k - w, p),
                                          ...
                                          b.lineTo(k - w, n),
                                          b.stroke(),
                                          da(b, v, Math.min(h, q), C, Math.max(h, q), e, 0, null, !1, !1, !1, !1)))
                                    : "ohlc" === t.type &&
                                      (c.moveTo(k - w, p),
                                      c.lineTo(k - w, n),
                                      c.stroke(),
                                      ...
                                      s &&
                                          ...
                                          b.lineTo(C, q),
                                          b.stroke()));
                                (x[u].indexLabel || t.indexLabel || x[u].indexLabelFormatter || t.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: t.type,
                                        dataPoint: x[u],
                                        dataSeries: t,
                                        point: { x: v + (C - v) / 2, y: a.axisY.reversed ? n : p },
                                        direction: 1,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var ga = !1, ga = !!a.axisY.reversed, O = 0; O < a.dataSeriesIndexes.length; O++) {
                    var t = a.dataSeriesIndexes[O],
                        ...
                        A = x.dataPoints;
                    if (0 < A.length)
                        for (var v = 5 < m && x.bevelEnabled ? !0 : !1, l = 0; l < A.length; l++)
                            if (
                                ...
                                var C = (u - m / 2) << 0,
                                    ...
                                    N = "number" === typeof A[l].lineThickness ? A[l].lineThickness : "number" === typeof x.options.lineThickness ? x.lineThickness : w,
                                ...
                                c.save();
                                0 < ca &&
                                    (c.beginPath(), (c.strokeStyle = na), (c.lineWidth = ca), c.setLineDash && c.setLineDash(Q(I, ca)), c.moveTo(u - F, h), c.lineTo(u - F, k), c.stroke(), c.moveTo(u - F, n), c.lineTo(u - F, p), c.stroke());
                                c.restore();
                                ...
                                c.lineWidth = w;
                                c.strokeStyle = e;
                                c.rect(C - D, Math.min(h, p) - D, y - C + 2 * D, Math.max(h, p) - Math.min(h, p) + 2 * D);
                                c.stroke();
                                c.save();
                                ...
                                s &&
                                    ...
                                    (b.strokeStyle = e),
                                    (b.lineWidth = ca),
                                    0 < ca && (b.moveTo(u - D - F, h), b.lineTo(u - D - F, Math.max(k, n)), b.stroke(), b.moveTo(u - D - F, Math.min(k, n)), b.lineTo(u - D - F, p), b.stroke()),
                                    da(b, C, Math.max(h, p), y, Math.min(h, p), e, 0, null, !1, !1, !1, !1),
                                    0 < P && (b.beginPath(), (b.lineWidth = P), b.moveTo(u + $ / 2, n - ia), b.lineTo(u - $ / 2, n - ia), b.stroke(), b.moveTo(u + $ / 2, k + ia), b.lineTo(u - $ / 2, k + ia), b.stroke()));
                                (A[l].indexLabel || x.indexLabel || A[l].indexLabelFormatter || x.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        direction: 1,
                                        bounds: { x1: C, y1: Math.min(k, n), x2: y, y2: Math.max(k, n) },
                                        color: e,
                                    });
                            }
                }
                    ...
                    if (0 < g.length)
                        for (var m = 5 < h && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            if (
                                ...
                                !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1])
                            ) {
                                ...
                                t = q.dataPointIds[f];
                                this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: f, x1: ga, y1: l, x2: O, y2: u };
        ...
        m.prototype.renderError = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var O = 0, t = 0; t < this.data.length; t++) !this.data[t].type.match(/(bar|column)/gi) || !this.data[t].visible || (this.data[t].type.match(/(stacked)/gi) && O) || O++;
                for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    var A = a.dataSeriesIndexes[x],
                        v = this.data[A],
                        C = v.dataPoints,
                        y = r(v._linkedSeries) ? !1 : v._linkedSeries.type.match(/(bar|column)/gi) && v._linkedSeries.visible ? !0 : !1,
                        D = 0;
                    if (y)
                    ...
                    f &&
                        (u = this.options.dataPointMaxWidth
                            ...
                            ? this.dataPointWidth
                            : b
                            ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (y ? O : 1))) << 0
                            : 0.03 * this.width);
                    ...
                    t > u && (t = u);
                    if (0 < C.length)
                        for (var E = v._colorSet, u = 0; u < C.length; u++) {
                            var e = (v.lineColor = v.options.color ? v.options.color : E[0]),
                                K = {
                                    ...
                                    trimLength: r(C[u].whiskerLength) ? (r(v.options.whiskerLength) ? 50 : 0) : 0,
                                };
                            ...
                            if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !r(C[u].y) && C[u].y.length && "number" === typeof C[u].y[0] && "number" === typeof C[u].y[1]) {
                                ...
                                b ? (n = ha) : (g = ha);
                                b
                                    ? ((q = a.axisX.reversed ? (h + ((y ? O : 1) * t) / 2 - (y ? D - 1 : 0) * t) << 0 : (h - ((y ? O : 1) * t) / 2 + (y ? D - 1 : 0) * t) << 0), (g = a.axisX.reversed ? (q - t) << 0 : (q + t) << 0))
                                    : ((p = a.axisX.reversed ? (k + ((y ? O : 1) * t) / 2 - (y ? D - 1 : 0) * t) << 0 : (k - ((y ? O : 1) * t) / 2 + (y ? D - 1 : 0) * t) << 0), (n = a.axisX.reversed ? (p - t) << 0 : (p + t) << 0));
                                !b && q > g && ((ha = q), (q = g), (g = ha));
                                b && p > n && ((ha = p), (p = n), (n = ha));
                                ha = v.dataPointIds[u];
                                ...
                                w(c, Math.min(p, n), Math.min(q, g), Math.max(n, p), Math.max(g, q), e, K, P, b);
                                s && w(this._eventManager.ghostCtx, p, q, n, g, e, K, P, b);
                                if (C[u].indexLabel || v.indexLabel || C[u].indexLabelFormatter || v.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "error",
                                        dataPoint: C[u],
                                        dataSeries: v,
                                        indexKeyword: 0,
                                        point: { x: b ? (C[u].y[1] >= C[u].y[0] ? p : n) : p + (n - p) / 2, y: b ? q + (g - q) / 2 : C[u].y[1] >= C[u].y[0] ? g : q },
                                        direction: C[u].y[1] >= C[u].y[0] ? -1 : 1,
                                        bounds: { x1: b ? Math.min(p, n) : p, y1: b ? q : Math.min(q, g), x2: b ? Math.max(p, n) : n, y2: b ? g : Math.max(q, g) },
                                        color: e,
                                        axisSwapped: b,
                                    }),
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: v,
                                            indexKeyword: 1,
                                            point: { x: b ? (C[u].y[1] >= C[u].y[0] ? n : p) : p + (n - p) / 2, y: b ? q + (g - q) / 2 : C[u].y[1] >= C[u].y[0] ? q : g },
                                            direction: C[u].y[1] >= C[u].y[0] ? 1 : -1,
                                            bounds: { x1: b ? Math.min(p, n) : p, y1: b ? q : Math.min(q, g), x2: b ? Math.max(p, n) : n, y2: b ? g : Math.max(q, g) },
                                            color: e,
                                            axisSwapped: b,
                    ...
                    if (0 < m.length) {
                        ...
                        for (f = 0; f < m.length; f++)
                            if (
                                ...
                                !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !r(m[f].y) && m[f].y.length && "number" === typeof m[f].y[0] && "number" === typeof m[f].y[1])
                            ) {
                                ...
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: k, x2: u, y2: v };
                                b = S(b);
                                s && da(this._eventManager.ghostCtx, l, k, u, v, b, 0, null, !1, !1, !1, !1);
                                if (m[f].indexLabel || g.indexLabel || m[f].indexLabelFormatter || g.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "rangeBar",
                                        dataPoint: m[f],
                                        dataSeries: g,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    var f = [],
                        ...
                        x = null;
                    if (0 < n.length) {
                        var A = p._colorSet[g % p._colorSet.length],
                            w = (p.lineColor = p.options.lineColor || A),
                            C = w;
                        b.fillStyle = A;
                        b.strokeStyle = w;
                        b.lineWidth = p.lineThickness;
                            ...
                            if (((t = n[g].x.getTime ? n[g].x.getTime() : n[g].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !K)))))
                                if (null !== n[g].y && n[g].y.length && "number" === typeof n[g].y[0] && "number" === typeof n[g].y[1]) {
                                    ...
                                    q || K
                                        ? (p.connectNullData && !q
                                              ? (b.setLineDash &&
                                                    (p.options.nullDataLineDashType || (y === p.lineDashType && p.lineDashType !== p.nullDataLineDashType)) &&
                                                    ((k[k.length - 1].newLineDashArray = E), (y = p.nullDataLineDashType), b.setLineDash(D)),
                                                b.lineTo(m, r),
                                                s && e.lineTo(m, r),
                                                k.push({ x: m, y1: r, y2: v }))
                                              : (b.beginPath(), b.moveTo(m, r), (x = { x: m, y: r }), (k = []), k.push({ x: m, y1: r, y2: v }), s && (e.beginPath(), e.moveTo(m, r))),
                                          (K = q = !1))
                                        : (b.lineTo(m, r), k.push({ x: m, y1: r, y2: v }), s && e.lineTo(m, r), 0 == g % 250 && d());
                                    t = p.dataPointIds[g];
                                    this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: g, x1: m, y1: r, y2: v };
                                    g < n.length - 1 &&
                                        (C !== (n[g].lineColor || w) || y !== (n[g].lineDashType || p.lineDashType)) &&
                                        (d(),
                                        (C = n[g].lineColor || w),
                                        (k[k.length - 1].newStrokeStyle = C),
                                        (b.strokeStyle = C),
                                        b.setLineDash &&
                                            (n[g].lineDashType
                                                ? ((y = n[g].lineDashType), (k[k.length - 1].newLineDashArray = Q(y, p.lineThickness)), b.setLineDash(k[k.length - 1].newLineDashArray))
                                                : ((y = p.lineDashType), (k[k.length - 1].newLineDashArray = E), b.setLineDash(E))));
                                    if (0 !== n[g].markerSize && (0 < n[g].markerSize || 0 < p.markerSize)) {
                                        var P = p.getMarkerProperties(g, m, v, b);
                                        f.push(P);
                                        var ha = S(t);
                                        s && f.push({ x: m, y: v, ctx: e, type: P.type, size: P.size, color: ha, borderColor: ha, borderThickness: P.borderThickness });
                                        P = p.getMarkerProperties(g, m, r, b);
                                        f.push(P);
                                        ha = S(t);
                                        s && f.push({ x: m, y: r, ctx: e, type: P.type, size: P.size, color: ha, borderColor: ha, borderThickness: P.borderThickness });
                                    }
                                    if (n[g].indexLabel || p.indexLabel || n[g].indexLabelFormatter || p.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: n[g], dataSeries: p, indexKeyword: 0, point: { x: m, y: r }, direction: n[g].y[0] > n[g].y[1] === a.axisY.reversed ? -1 : 1, color: A }),
                                            this._indexLabels.push({
                                                chartType: "rangeArea",
                                                dataPoint: n[g],
                                                dataSeries: p,
                        ...
                        for (g = !1; n < p.length; n++)
                            if (((q = p[n].x.getTime ? p[n].x.getTime() : p[n].x), !(q < a.axisX.dataInfo.viewPortMin || (q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g)))))
                                if (null !== p[n].y && p[n].y.length && "number" === typeof p[n].y[0] && "number" === typeof p[n].y[1]) {
                                    ...
                                    this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: n, x1: q, y1: g, y2: B };
                                    r[r.length] = { x: q, y: g };
                                    O[O.length] = { x: q, y: B };
                                    n < p.length - 1 &&
                                        (A !== (p[n].lineColor || x) || w !== (p[n].lineDashType || h.lineDashType)) &&
                                        ((A = p[n].lineColor || x),
                                        (r[r.length - 1].newStrokeStyle = A),
                                        b.setLineDash && (p[n].lineDashType ? ((w = p[n].lineDashType), (r[r.length - 1].newLineDashArray = Q(w, h.lineThickness))) : ((w = h.lineDashType), (r[r.length - 1].newLineDashArray = C))));
                                    if (0 !== p[n].markerSize && (0 < p[n].markerSize || 0 < h.markerSize)) {
                                        var E = h.getMarkerProperties(n, q, g, b);
                                        f.push(E);
                                        var K = S(D);
                                        s && f.push({ x: q, y: g, ctx: e, type: E.type, size: E.size, color: K, borderColor: K, borderThickness: E.borderThickness });
                                        E = h.getMarkerProperties(n, q, B, b);
                                        f.push(E);
                                        K = S(D);
                                        s && f.push({ x: q, y: B, ctx: e, type: E.type, size: E.size, color: K, borderColor: K, borderThickness: E.borderThickness });
                                    }
                                    if (p[n].indexLabel || h.indexLabel || p[n].indexLabelFormatter || h.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: p[n], dataSeries: h, indexKeyword: 0, point: { x: q, y: g }, direction: p[n].y[0] <= p[n].y[1] ? -1 : 1, color: t }),
                                            this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: p[n], dataSeries: h, indexKeyword: 1, point: { x: q, y: B }, direction: p[n].y[0] <= p[n].y[1] ? 1 : -1, color: t });
                                    g = !1;
                                } else
                                    0 < n &&
                                        !g &&
                                        (h.connectNullData
                                            ? b.setLineDash && 0 < r.length && (h.options.nullDataLineDashType || !p[n - 1].lineDashType) && ((r[r.length - 1].newLineDashArray = y), (w = h.nullDataLineDashType))
                                            : (d(C, x), (r = []), (O = []))),
                                        (g = !0);
                        d(C, x);
                        Y.drawMarkers(f);
        ...
        m.prototype.renderWaterfall = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < O.length)
                        for (var A = 5 < q && v.bevelEnabled ? !0 : !1, w = !1, C = null, y = null, l = 0; l < O.length; l++)
                            if ((O[l].getTime ? (p = O[l].x.getTime()) : (p = O[l].x), "number" !== typeof O[l].y)) {
                                ...
                                e = v.dataPointIds[l];
                                this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: l, x1: k, y1: m, x2: E, y2: h };
                                ...
                                var P,
                                    K = k;
                                P =
                                    ("undefined" !== typeof O[l].isIntermediateSum && !0 === O[l].isIntermediateSum) || ("undefined" !== typeof O[l].isCumulativeSum && !0 === O[l].isCumulativeSum)
                                        ? 0 < O[l].y
                                            ? m
                                            : h
                                        : 0 < O[l].y
                                ...
                                0 < l &&
                                    ...
                                    c.lineTo(K, P - x),
                                    0 < t && c.stroke(),
                                    s && (b.beginPath(), b.moveTo(C, y - x), b.lineTo(K, P - x), 0 < t && b.stroke()));
                                w = !1;
                                C = E;
                                y = 0 < O[l].y ? m : h;
                                ...
                                (O[l].indexLabel || v.indexLabel || O[l].indexLabelFormatter || v.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "waterfall",
                                        dataPoint: O[l],
                                        dataSeries: v,
        ...
        m.prototype.renderPie = function (a) {
            function d() {
                if (h && p) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < p.length; e++) {
                        ...
                        if (h.indexLabelFormatter || f.indexLabelFormatter) u = { chart: m.options, dataSeries: h, dataPoint: f, total: k.total, percent: k.percent };
                    ...
                    for (e = 0; e < p.length; e++)
                        (n = g[(c + e) % p.length]), 1 < a && n.midAngle > Math.PI / 2 - t && n.midAngle < Math.PI / 2 + t && (f <= a / 2 && !k ? ((n.hemisphere = "right"), f++) : ((n.hemisphere = "left"), (k = !0)));
                    k = !1;
                    for (e = 0; e < p.length; e++)
                        (n = g[(d + e) % p.length]), 1 < b && n.midAngle > (3 * Math.PI) / 2 - t && n.midAngle < (3 * Math.PI) / 2 + t && (l <= b / 2 && !k ? ((n.hemisphere = "left"), l++) : ((n.hemisphere = "right"), (k = !0)));
                }
            }
            function c(a) {
                    ...
                    (c = g[b]),
                        c.indexLabelText &&
                            ...
                            "inside" !== c.indexLabelPlacement &&
                                ...
                                a.setLineDash && a.setLineDash(Q(c.indexLabelLineDashType, c.indexLabelLineThickness)),
                                a.beginPath(),
                                a.moveTo(d, e),
                                a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y),
                                a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -n : n), c.indexLabelTextBlock.y),
                                a.stroke()),
                            (a.lineJoin = "miter"));
                a.save();
            }
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < p.length) {
                    ...
                    var k = 0,
                        ...
                        q = (k = k = 0);
                    0 > c
                        ? m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2 > l && m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2 + c < l && (c = -(l - (m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2 + c)))
                        : m.indexLabelTextBlock.y + m.indexLabelTextBlock.height / 2 < l && m.indexLabelTextBlock.y + m.indexLabelTextBlock.height / 2 + c > n && (c = m.indexLabelTextBlock.y + m.indexLabelTextBlock.height / 2 + c - n);
                    ...
                    0 > c
                        ? ((n = "right" === m.hemisphere ? q : k),
                          ...
                          null !== n &&
                              ((q = -c),
                              (c = m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2 - (g[n].indexLabelTextBlock.y + g[n].indexLabelTextBlock.height / 2)),
                              c - q < B && ((l = -q), (n = f(n, l, d + 1)), +n.toFixed(x) > +l.toFixed(x) && (h = c > B ? -(c - B) : -(q - (n - l))))))
                        : 0 < c &&
                          ((n = "right" === m.hemisphere ? k : q),
                          (h = c),
                          null !== n &&
                              ((q = c),
                              (c = g[n].indexLabelTextBlock.y - g[n].indexLabelTextBlock.height / 2 - (m.indexLabelTextBlock.y + m.indexLabelTextBlock.height / 2)),
                              c - q < B && ((l = q), (n = f(n, l, d + 1)), +n.toFixed(x) < +l.toFixed(x) && (h = c > B ? c - B : q - (l - n)))));
                    h &&
                        ((d = m.indexLabelTextBlock.y + h),
                        (c = 0),
                        (c = "right" === m.hemisphere ? A.x + Math.sqrt(Math.pow(s, 2) - Math.pow(d - A.y, 2)) : A.x - Math.sqrt(Math.pow(s, 2) - Math.pow(d - A.y, 2))),
                        m.midAngle > Math.PI / 2 - t && m.midAngle < Math.PI / 2 + t
                            ? ((l = (a - 1 + g.length) % g.length),
                              (l = g[l]),
                              (a = g[(a + 1 + g.length) % g.length]),
                              "left" === m.hemisphere && "right" === l.hemisphere && c > l.indexLabelTextBlock.x
                                  ? (c = l.indexLabelTextBlock.x - 15)
                                  : "right" === m.hemisphere && "left" === a.hemisphere && c < a.indexLabelTextBlock.x && (c = a.indexLabelTextBlock.x + 15))
                            : m.midAngle > (3 * Math.PI) / 2 - t &&
                              m.midAngle < (3 * Math.PI) / 2 + t &&
                              ((l = (a - 1 + g.length) % g.length),
                              (l = g[l]),
                              (a = g[(a + 1 + g.length) % g.length]),
                              "right" === m.hemisphere && "left" === l.hemisphere && c < l.indexLabelTextBlock.x
                                  ? (c = l.indexLabelTextBlock.x + 15)
                                  : "left" === m.hemisphere && "right" === a.hemisphere && c > a.indexLabelTextBlock.x && (c = a.indexLabelTextBlock.x - 15)),
                        (m.indexLabelTextBlock.y = d),
                        (m.indexLabelTextBlock.x = c),
                        (m.indexLabelAngle = Math.atan2(m.indexLabelTextBlock.y - A.y, m.indexLabelTextBlock.x - A.x)));
                }
                return h;
            }
            function l() {
                            ...
                            if (null !== r) {
                                ...
                                if (0 > C) {
                                    ...
                                    var w = -1 * (C - t),
                                        I = (J = 0);
                                    "right" === k.hemisphere
                                        ? ((J = f(a, t)), (w = -1 * (C - J)), (I = f(r, w)), +I.toFixed(x) < +w.toFixed(x) && +J.toFixed(x) <= +t.toFixed(x) && f(a, -(w - I)))
                                        : ((J = f(r, t)), (w = -1 * (C - J)), (I = f(a, w)), +I.toFixed(x) < +w.toFixed(x) && +J.toFixed(x) <= +t.toFixed(x) && f(r, -(w - I)));
                                }
                            }
                        }
                    } else
                        for (a = 0; a < p.length; a++)
                            (k = g[a]), (s = "pie" === h.type ? 0.7 * y : 0.8 * y), (r = A.x + s * Math.cos(k.midAngle)), (t = A.y + s * Math.sin(k.midAngle)), (k.indexLabelTextBlock.x = r), (k.indexLabelTextBlock.y = t);
                    for (a = 0; a < p.length; a++)
                        if (((k = g[a]), (r = k.indexLabelTextBlock.measureText()), 0 !== r.height && 0 !== r.width))
                            (r = r = 0),
                                "right" === k.hemisphere ? ((r = q.x2 - (k.indexLabelTextBlock.x + k.indexLabelTextBlock.width + n)), (r *= -1)) : (r = q.x1 - (k.indexLabelTextBlock.x - k.indexLabelTextBlock.width - n)),
                                0 < r &&
                                    (!l &&
                                        k.indexLabelText &&
                                        ((t = "right" === k.hemisphere ? q.x2 - k.indexLabelTextBlock.x : k.indexLabelTextBlock.x - q.x1),
                                        0.3 * k.indexLabelTextBlock.maxWidth > t ? (k.indexLabelText = "") : (k.indexLabelTextBlock.maxWidth = 0.85 * t),
                                        0.3 * k.indexLabelTextBlock.maxWidth < t && (k.indexLabelTextBlock.x -= "right" === k.hemisphere ? 2 : -2)),
                                    Math.abs(k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - A.y) < y || Math.abs(k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 - A.y) < y) &&
                                    ((r /= Math.abs(Math.cos(k.indexLabelAngle))), 9 < r && (r *= 0.3), r > d && (d = r)),
                                (r = r = 0),
                                0 < k.indexLabelAngle && k.indexLabelAngle < Math.PI
                                    ? ((r = q.y2 - (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 + 5)), (r *= -1))
                                    : (r = q.y1 - (k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - 5)),
                                0 < r &&
                                    (!l && k.indexLabelText && ((t = 0 < k.indexLabelAngle && k.indexLabelAngle < Math.PI ? -1 : 1), 0 === f(a, r * t) && f(a, 2 * t)),
                                    Math.abs(k.indexLabelTextBlock.x - A.x) < y && ((r /= Math.abs(Math.sin(k.indexLabelAngle))), 9 < r && (r *= 0.3), r > d && (d = r)));
                            ...
                            if (((f = !1), (u = g[h]), u.indexLabelText)) {
                                ...
                                if (null !== l) {
                                    ...
                                    if ((m = 0 > C)) {
                                        ...
                                        m = u.indexLabelTextBlock.x + u.indexLabelTextBlock.width < k.indexLabelTextBlock.x - n || m > B + n || q > z + n || t < r - n ? !1 : !0;
                                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var C = 0; C < p.length; C++)
                    (w += Math.abs(p[C].y)),
                        !a && "undefined" !== typeof p[C].indexLabel && null !== p[C].indexLabel && 0 < p[C].indexLabel.toString().length && (a = !0),
                        !a && "undefined" !== typeof p[C].label && null !== p[C].label && 0 < p[C].label.toString().length && (a = !0);
                if (0 !== w) {
        ...
        m.prototype.renderFunnel = function (a) {
            ...
            function c() {
                ...
                if (0 === g) return -1;
                for (var l = (d[0] = 0), k = 0, n, m, b = b - a, l = !1, h = 0; h < x.length; h++)
                    (a = (Math.abs(x[h].y) * f) / g),
                        l
                            ? (n = 0 == Number(c.toFixed(3)) ? 0 : a / c)
                            : ((m = ba * ba * b * b - 4 * Math.abs(ba) * a),
                              0 > m
                                  ? ((m = c), (l = ((b + m) * (e - k)) / 2), (a -= l), (n = e - k), (k += e - k), (n += 0 == m ? 0 : a / m), (k += a / m), (l = !0))
                                  : ((n = (Math.abs(ba) * b - Math.sqrt(m)) / 2),
                                    (m = b - (2 * n) / Math.abs(ba)),
                                    (k += n),
                                    k > e && ((k -= n), (m = c), (l = ((b + m) * (e - k)) / 2), (a -= l), (n = e - k), (k += e - k), (n += a / m), (k += a / m), (l = !0)),
                                    (b = m))),
                        d.push(n);
                return d;
            }
            function b() {
                if (t && x) {
                    for (var a, b, c, d, e, f, h, l, k, n, m, p, q, u, B = [], z = [], v = { percent: null, total: null }, A = null, y = 0; y < x.length; y++)
                        (u = R[y]), (u = "undefined" !== typeof u.x5 ? (u.y2 + u.y4) / 2 : (u.y2 + u.y3) / 2), (u = g(u).x2 + 1), (B[y] = N - u - W);
                    u = 0.5 * W;
                    for (var y = 0, C = x.length - 1; y < x.length || 0 <= C; y++, C--) {
                        ...
                        q = t.dataPointIds[y];
                        w._eventManager.objectMap[q] = { id: q, objectType: "dataPoint", dataPointIndex: y, dataSeriesIndex: 0, funnelSection: R[t.reversed ? x.length - 1 - y : y] };
                        "inside" === t.indexLabelPlacement &&
                            ((B[y] = y !== da ? (t.reversed ? R[y].x2 - R[y].x1 : R[y].x3 - R[y].x4) : R[y].x3 - R[y].x6),
                            20 > B[y] && ((B[y] = y !== da ? (t.reversed ? R[y].x3 - R[y].x4 : R[y].x2 - R[y].x1) : R[y].x2 - R[y].x1), (B[y] /= 2)));
                        q = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth : B[y];
                        if (q > B[y] || 0 > q) q = B[y];
                        z[y] = "inside" === t.indexLabelPlacement ? R[y].height : !1;
                        v = w.getPercentAndTotal(t, b);
                        if (t.indexLabelFormatter || b.indexLabelFormatter) A = { chart: w.options, dataSeries: t, dataPoint: b, total: v.total, percent: v.percent };
                        b = b.indexLabelFormatter
                            ? b.indexLabelFormatter(A)
                            : b.indexLabel
                            ? w.replaceKeywordsWithValue(b.indexLabel, b, t, y)
                            : t.indexLabelFormatter
                            ? t.indexLabelFormatter(A)
                            : t.indexLabel
                ...
                if (e)
                    for (l = H.length - 1; 0 <= l; l--)
                        (a = R[l]),
                            ...
                            (H[l].textBlock.x = N - h),
                            (c = H[l].textBlock.height < H[l].textBlock.maxHeight ? H[l].textBlock.height : H[l].textBlock.maxHeight),
                            (e = H[l].textBlock.width < H[l].textBlock.maxWidth ? H[l].textBlock.width : H[l].textBlock.maxWidth),
                            (H[l].height = c),
                            (H[l].width = e),
                            (c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2),
                            (H[l].textBlock.y = c - H[l].height / 2),
                            t.reversed
                                ? (H[l].textBlock.y + H[l].height > U + D && (H[l].textBlock.y = U + D - H[l].height), H[l].textBlock.y < sa - D && (H[l].textBlock.y = sa - D))
                                : (H[l].textBlock.y < U - D && (H[l].textBlock.y = U - D), H[l].textBlock.y + H[l].height > sa + D && (H[l].textBlock.y = sa + D - H[l].height));
            }
            function f() {
                var a, b, c, d;
                    ...
                    for (var e = 0; e < R.length; e++)
                        0 == H[e].textBlock.text.length
                            ...
                            : ((a = R[e]),
                              ...
                              t.reversed
                                  ? (H[e].textBlock.y + H[e].height > U + D && (H[e].textBlock.y = U + D - H[e].height), H[e].textBlock.y < sa - D && (H[e].textBlock.y = sa - D))
                                  : (H[e].textBlock.y < U - D && (H[e].textBlock.y = U - D), H[e].textBlock.y + H[e].height > sa + D && (H[e].textBlock.y = sa + D - H[e].height)));
                else
                    for (e = 0; e < R.length; e++)
                        0 == H[e].textBlock.text.length
                            ...
                            : ((a = R[e]),
                              ...
                              (d = H[e].width),
                              b >= c
                                  ? ((b = e != da ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2), (c = e != da ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2), (H[e].textBlock.x = b), (H[e].textBlock.y = c))
                                  : (H[e].isDirty = !0));
            }
            function l() {
                function a(b, c) {
                    ...
                    for (var l, k = 1; k < h; k++) {
                        ...
                        for (var p = H.length - 1; 0 <= p; p--)
                            !H[p].isDirty &&
                                ...
                                ((l = q(p)), !(l >= H.length - 1) && H[p].textBlock.y + H[p].height + ea > H[l].textBlock.y && (H[p].textBlock.y = H[p].textBlock.y + H[p].height - e > e - H[p].textBlock.y ? e + 1 : e - H[p].height - 1));
                    }
                ...
                for (var d, e, f, g, h, l, m = 1, p = 0; p < 2 * m; p++) {
                    for (
                        ...
                        (e = +g.y.toFixed(6)),
                        !f.isDirty && h && e + d + ea > +l.y.toFixed(6) && ((d = g.y + d + ea - l.y), (e = a(t, -d)), e < d && (0 < e && (d -= e), (e = a(q(t), d)), e != d)));
                        t--
                    );
                    b();
                }
            ...
            function p(a) {
                for (var b, c, d, e, f = 0; f < R.length; f++)
                    (e = 1 === H[f].lineThickness % 2 ? 0.5 : 0),
                        ...
                        H[f].isDirty ||
                            0 == H[f].lineThickness ||
                            ((a.strokeStyle = H[f].lineColor), (a.lineWidth = H[f].lineThickness), a.setLineDash && a.setLineDash(Q(H[f].lineDashType, H[f].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke());
            }
            function n(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (
                    var t = this.data[a.dataSeriesIndexes[0]], x = t.dataPoints, A = this.plotArea, D = 0.025 * A.width, C = 0.01 * A.width, y = 0, E = A.height - 2 * D, G = Math.min(A.width - 2 * C, 2.8 * A.height), K = !1, P = 0;
                    P < x.length;
                    P++
                )
                    if (
                        (!K && "undefined" !== typeof x[P].indexLabel && null !== x[P].indexLabel && 0 < x[P].indexLabel.toString().length && (K = !0),
                        !K && "undefined" !== typeof x[P].label && null !== x[P].label && 0 < x[P].label.toString().length && (K = !0),
                        (!K && "function" === typeof t.indexLabelFormatter) || "function" === typeof x[P].indexLabelFormatter)
                    )
                        K = !0;
                ...
                if (0 != t.length && t.dataPoints && t.visible && 0 !== x.length) {
                    ...
                    "funnel" === t.type
                        ? ((ca = r(t.options.neckHeight) ? 0.35 * E : t.neckHeight),
                          ...
                          "string" === typeof ca && ca.match(/%$/) ? ((ca = parseInt(ca)), (ca = (ca * E) / 100)) : (ca = parseInt(ca)),
                          "string" === typeof F && F.match(/%$/) ? ((F = parseInt(F)), (F = (F * a) / 100)) : (F = parseInt(F)),
                          ca > E ? (ca = E) : 0 >= ca && (ca = 0),
                          F > a ? (F = a - 0.5) : 0 >= F && (F = 0))
                        : "pyramid" === t.type && ((F = ca = 0), (t.reversed = t.reversed ? !1 : !0));
                    var C = P + a / 2,
                        X = P,
                        aa = P + a,
                        U = t.reversed ? T : $,
                    ...
                    if (-1 !== P) {
                        if (t.reversed) for (G.push(V), F = P.length - 1; 0 < F; F--) (V += P[F]), G.push(V);
                        else for (F = 0; F < P.length; F++) (V += P[F]), G.push(V);
                        if (t.reversed) for (F = 0; F < P.length; F++) G[F] < xa ? (a.push(M), C.push(Y), (da = F)) : (a.push((G[F] - U + ba * X) / ba), C.push((G[F] - U + fa * aa) / fa));
                        else for (F = 0; F < P.length; F++) G[F] < xa ? (a.push((G[F] - U + ba * X) / ba), C.push((G[F] - U + fa * aa) / fa), (da = F)) : (a.push(M), C.push(Y));
                        for (F = 0; F < P.length - 1; F++)
                            (V = t.reversed ? (x[x.length - 1 - F].color ? x[x.length - 1 - F].color : t._colorSet[(x.length - 1 - F) % t._colorSet.length]) : x[F].color ? x[F].color : t._colorSet[F % t._colorSet.length]),
                                F === da
                                    ? R.push({ x1: a[F], y1: G[F], x2: C[F], y2: G[F], x3: Y, y3: xa, x4: C[F + 1], y4: G[F + 1], x5: a[F + 1], y5: G[F + 1], x6: M, y6: xa, id: F, height: G[F + 1] - G[F], color: V })
                                    : R.push({ x1: a[F], y1: G[F], x2: C[F], y2: G[F], x3: C[F + 1], y3: G[F + 1], x4: a[F + 1], y4: G[F + 1], id: F, height: G[F + 1] - G[F], color: V });
                        var ea = 2,
                            H = [],
                            ka = !1,
                            Z = [],
                        ...
                        if (!K)
                            for (F = 0; F < x.length; F++)
                                (y = t.dataPointIds[F]), (a = { id: y, objectType: "dataPoint", dataPointIndex: F, dataSeriesIndex: 0, funnelSection: R[t.reversed ? x.length - 1 - F : F] }), (w._eventManager.objectMap[y] = a);
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
                ...
                if ("x" === a)
                    if ("dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || (d.x && d.x.getTime)) {
                        if (f.plotInfo.plotTypes[0].plotUnits[0].axisX && !f.plotInfo.plotTypes[0].plotUnits[0].axisX.logarithmic)
                            return Aa(
                                g,
                    ...
                    return "y" === a
                        ? fa(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : (c.yValueFormatString = "#,##0.########"), f._cultureInfo)
                        : "z" === a
                        ? fa(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : (c.zValueFormatString = "#,##0.########"), f._cultureInfo)
                        : g;
            });
        };
        oa(E, X);
        E.prototype.setLayout = function () {
            ...
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ...
                : "center" === this.verticalAlign &&
                  ((this.orientation = "vertical"), (c = this.horizontalAlign), (f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : 0.5 * d.width), (l = this.maxHeight = null !== this.maxHeight ? this.maxHeight : d.height));
                        ...
                        for (var x = 0; x < n.dataPoints.length; x++) {
                            var A = n.dataPoints[x],
                                ...
                                t = A.legendMarkerBorderThickness
                                    ...
                                    : 0,
                                g = this.chart.replaceKeywordsWithValue(g, A, n, x),
                                q = { markerType: q, markerColor: B, text: g, textBlock: null, chartType: n.type, markerSize: s, dataSeriesIndex: p, dataPointIndex: x, markerBorderColor: v, markerBorderThickness: t };
                    ...
                    if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (
                                !n ||
                                n.width +
                                    Math.round(q.textBlock.width + s + k + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) >
                                    f
                            )
                                (n = { items: [], width: 0 }), h.push(n), (this.height += g), (g = 0);
                            ...
                            (q.textBlock = new la(this.ctx, {
                                ...
                                q.textBlock.measureText(),
                                null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (s + k + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                                this.height < l - this.lineHeight ? ((n = { items: [], width: 0 }), h.push(n)) : ((n = h[x]), (x = (x + 1) % h.length)),
            ...
            for (p = 0; p < this.items.length; p++)
                (q = m[p]),
                    ...
                    (this.chart._eventManager.objectMap[q.id] = { id: q.id, objectType: "legendItem", legendItemIndex: p, dataSeriesIndex: q.dataSeriesIndex, dataPointIndex: q.dataPointIndex });
            this.markerSize = s;
            this.rows = h;
        ...
        G.prototype.getDataPointAtX = function (a, d) {
            ...
            "none" !== this.chart.plotInfo.axisPlacement &&
                (this.axisX.logarithmic
                    ? ((p = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x)),
                      (p = 1 < p ? Math.min(Math.max((((this.dataPoints.length - 1) / p) * Math.log(a / this.dataPoints[0].x)) >> 0, 0), this.dataPoints.length) : 0))
                    : ((p = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x), (p = 0 < p ? Math.min(Math.max((((this.dataPoints.length - 1) / p) * (a - this.dataPoints[0].x)) >> 0, 0), this.dataPoints.length) : 0)));
            for (;;) {
                f = 0 < l ? p + e : p - e;
                        ...
                        switch (this.type) {
                            ...
                            case "error":
                                a >= q.x1 &&
                                    ...
                                    d >= q.y1 &&
                                    d <= q.y2 &&
                                    (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y1 - d), Math.abs(q.y2 - d)) }), (k = !0));
                                break;
                            case "line":
                            case "stepLine":
                            case "spline":
                            ...
                            case "bubble":
                                s = q.size;
                                r = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2));
                                r <= s / 2 && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: r }), (k = !0));
                                break;
                            case "pie":
                            case "doughnut":
                                s = q.center;
                                ...
                                r < q.radius &&
                                    ...
                                    (v = Number(((((180 * (q.endAngle / Math.PI)) % 360) + 360) % 360).toFixed(12))),
                                    0 === v && 1 < q.endAngle && (v = 360),
                                    s >= v && 0 !== g.y && ((v += 360), r < s && (r += 360)),
                                    r > s && r < v && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: 0 }), (k = !0)));
                                break;
                            case "funnel":
                            case "pyramid":
                                r = q.funnelSection;
                                d > r.y1 &&
                                    ...
                                    a > f && a < r && (b.push({ dataPoint: g, dataPointIndex: q.dataPointIndex, dataSeries: this, distance: 0 }), (k = !0)));
                                break;
                            case "boxAndWhisker":
                                if (
                                    ...
                                    b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d)) }), (k = !0);
                                break;
                            case "candlestick":
                                if (
        ...
        D.prototype.createLabels = function () {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                        ...
                        if (((c = this.logLabelValues[b]), c < this.viewportMinimum)) b++;
                            ...
                            a ||
                                ((a = this.labelFormatter
                                    ? this.labelFormatter({ chart: this.chart, axis: this.options, value: p, label: this.labels[p] ? this.labels[p] : null })
                ...
                for (
                    ...
                    a ||
                        ((a = this.labelFormatter
                            ? this.labelFormatter({ chart: this.chart, axis: this.options, value: new Date(p), label: this.labels[p] ? this.labels[p] : null })
                            : "axisX" === this.type && this.labels[p]
                            ? this.labels[p]
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                for (var v, g = a.text.split(" "), b = 0; b < g.length; b++)
                                    (p = g[b]), (this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily), (p = this.ctx.measureText(p)), p.width > q && ((v = c), (q = p.width));
                            }
                        c = 0;
                            ...
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (
                                        ...
                                        (p = (h - (m + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(-25))) / Math.sin((Math.PI / 180) * Math.abs(-25))),
                                        !r(this.options.labelWrap))
                                    )
                                        this.labelWrap
                                            ? r(this.options.labelMaxWidth)
                                                ? ((this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), p)),
                                                  (this.sessionVariables.labelWrap = this.labelWrap),
                                                  d && (B.width + d.width) >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
                                                : ((this.sessionVariables.labelWrap = this.labelWrap),
                                            ...
                                            ? ((this.sessionVariables.labelWrap = this.labelWrap),
                                              (this.sessionVariables.labelMaxHeight = l),
                                              (this.sessionVariables.labelMaxWidth = f),
                                              d && (B.width + d.width) >> 0 > 2 * f && ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = p)))
                                            : ((this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle),
                                              (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth),
                                              (this.sessionVariables.labelMaxHeight = l),
                                              (this.sessionVariables.labelWrap = this.labelWrap));
                                        ...
                                        if (r(this.options.labelWrap))
                                            if (!r(this.options.labelMaxWidth))
                                                ...
                                                if (((b = (B.width + d.width) >> 0), (g = this.labelFontSize), q < f))
                                                    b - 2 * f > n &&
                                                        ((n = b - 2 * f),
                                                        b >= 2 * f && b < 2.2 * f
                                                            ? ((this.sessionVariables.labelMaxWidth = f),
                                                              ...
                                                              (this.sessionVariables.labelAngle = this.labelAngle))
                                                            : b >= 2.2 * f && b < 2.8 * f
                                                            ? ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = p), (this.sessionVariables.labelFontSize = g))
                                                            : b >= 2.8 * f && b < 3.2 * f
                                                    ...
                                                    for (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++)
                                                        (a = this._labels[b].textBlock),
                                                            (a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), p)),
                                                            (B = a.measureText()),
                                                            b < this._labels.length - 1 &&
                                                                ((g = b + 1),
                                                                (d = this._labels[g].textBlock),
                                                                (d.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), p)),
                                                                (d = d.measureText()),
                                                                (B.width + d.width) >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25));
                                    }
                                else
                                    ((this.sessionVariables.labelAngle = this.labelAngle),
                                    ...
                                    (p = 0 != this.labelAngle ? (h - (m + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.sin((Math.PI / 180) * Math.abs(this.labelAngle)) : f),
                                    (this.sessionVariables.labelMaxHeight = l = this.labelWrap
                                        ? (h - p * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))
                                    ...
                                    r(this.options.labelWrap))
                                        ? r(this.options.labelWrap) &&
                                          (this.labelWrap && !r(this.options.labelMaxWidth)
                                              ...
                                              : ((this.sessionVariables.labelAngle = this.labelAngle),
                                                (this.sessionVariables.labelMaxWidth = p),
                                                (this.sessionVariables.labelMaxHeight = b < 0.9 * k ? 0.9 * k : b),
                                                (this.sessionVariables.labelWrap = this.labelWrap)))
                                        : (this.options.labelWrap
                                              ? ((this.sessionVariables.labelWrap = this.labelWrap), (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : p))
                                              : (r(this.options.labelMaxWidth), (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : p), (this.sessionVariables.labelWrap = this.labelWrap)),
                                          (this.sessionVariables.labelMaxHeight = l));
                            }
                        for (b = 0; b < this._labels.length; b++)
                            (a = this._labels[b].textBlock),
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("bottom" === this._position || "top" === this._position)
                        r(f.options.labelWrap) && !r(this.sessionVariables.stripLineLabelMaxHeight)
                            ...
                            : (this.sessionVariables.stripLineLabelMaxHeight = w = f.labelWrap ? (0.8 * this.chart.height) >> 0 : 1.5 * this.labelFontSize);
                    if ("left" === this._position || "right" === this._position)
                        r(f.options.labelWrap) && !r(this.sessionVariables.stripLineLabelMaxHeight)
                            ? (w = this.sessionVariables.stripLineLabelMaxHeight)
                            : (this.sessionVariables.stripLineLabelMaxHeight = w = f.labelWrap ? (0.8 * this.chart.width) >> 0 : 1.5 * this.labelFontSize);
                    ...
                    (l = "bottom" === this._position || "top" === this._position ? (0.9 * this.chart.width) >> 0 : (0.9 * this.chart.height) >> 0),
                        (w = r(f.options.labelWrap) || f.labelWrap ? ("bottom" === this._position || "top" === this._position ? (0.8 * this.chart.width) >> 0 : (0.8 * this.chart.height) >> 0) : 1.5 * this.labelFontSize),
                        r(f.labelBackgroundColor) && (r(f.startValue) && 0 !== f.startValue ? (f.labelBackgroundColor = s ? "transparent" : null) : (f.labelBackgroundColor = "#EEEEEE"));
                a = new la(this.ctx, {
                    x: 0,
                    y: 0,
        ...
        D.setLayout = function (a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                    for (var B = q[g].scaleBreaks._appliedBreaks, s = 0; s < B.length && !(B[s].startValue > q[g].viewportMaximum); s++)
                        B[s].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = s), B[s].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = s));
            for (var v = (s = 0), t = 0, x = 0, w = 0, D = 0, C = 0, y, E, G = (k = 0), I, P, L, B = (I = P = L = !1), g = 0; g < q.length; g++)
                q[g] &&
                    q[g].title &&
            ...
            if ("normal" === e) {
                for (var x = [], w = [], D = [], C = [], N = [], Q = [], S = [], T = []; 4 > s; ) {
                    var F = 0,
                        ...
                        R = 0,
                        ba = 0;
                    if (c && 0 < c.length) for (D = [], g = R = 0; g < c.length; g++) D.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), (R += D[g]), (M += c[g] && !p.isNavigator ? c[g].margin : 0);
                    else D.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    S.push(D);
                    if (b && 0 < b.length) for (C = [], g = ba = 0; g < b.length; g++) C.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), (ba += C[g]), (aa += b[g] ? b[g].margin : 0);
                    ...
                    if (d && 0 < d.length)
                        for (w = [], g = Y = 0; g < d.length; g++)
                            d[g] && (d[g].lineCoordinates = {}),
                                ...
                                w.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)),
                                (Y += w[g]),
                        ...
                        for (g = 0; g < a.length; g++)
                            a[g] &&
                                ...
                                a[g]._labels &&
                                    ...
                                    ((k = h = 0),
                                    (h = a[g]._labels[1]),
                                    (k = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1]),
                                    (v = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))),
                                    (t = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle)))),
                                !a[g] ||
                                    !a[g].labelAutoFit ||
                                    r(y) ||
                                    r(E) ||
                                    ...
                                    ((k = 0),
                                    0 < a[g].labelAngle
                                        ? E + t > m && (k += 0 < a[g].labelAngle ? E + t - m - ba : 0)
                                        : 0 > a[g].labelAngle
                                        ? y - v < l && y - v < a[g].viewportMinimum && (G = l - (M + a[g].tickLength + D + y - v + a[g].labelFontSize / 2))
                                        : 0 === a[g].labelAngle && (E + t > m && (k = E + t / 2 - m - ba), y - v < l && y - v < a[g].viewportMinimum && (G = l - M - a[g].tickLength - D - y + v / 2)),
                                    a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < k
                                        ? (m -= k)
                                        : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < G
                                        ? (l += G)
                                        : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < G && (l += G), 0 < k && (m -= k))),
                                p.panEnabled ? (V = r(p.sessionVariables.axisX.height) ? (p.sessionVariables.axisX.height = V) : p.sessionVariables.axisX.height) : (p.sessionVariables.axisX.height = V),
                                ...
                                (a[g].bounds = { x1: l, y1: k, x2: m, y2: h - (V + e - x[g] - F), width: m - l, height: h - k })),
                                (F += x[g] + a[g].margin);
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            (d[g].lineCoordinates.x1 = Math.round(f.x1 + R + M)),
                                (d[g].lineCoordinates.x2 = Math.round(f.x2 - ba - aa > p.width - n ? p.width - n : f.x2 - ba - aa)),
                                (d[g].lineCoordinates.width = Math.abs(m - l)),
                                d[g]._labels &&
                                    1 < d[g]._labels.length &&
                                    ((h = d[g]._labels[1]),
                                    (k = "dateTime" === d[g].valueType ? d[g]._labels[d[g]._labels.length - 2] : d[g]._labels[d[g]._labels.length - 1]),
                                    (v = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))),
                                    (t = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle)))),
                                p.panEnabled ? (Y = r(p.sessionVariables.axisX2.height) ? (p.sessionVariables.axisX2.height = Y) : p.sessionVariables.axisX2.height) : (p.sessionVariables.axisX2.height = Y),
                                (k = Math.round(f.y1)),
                                (h = Math.round(f.y2 + d[g].margin)),
                                (d[g].lineCoordinates.y1 = k + Y + Z - W),
                                (d[g].lineCoordinates.y2 = k),
                                "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[g - 1].bounds.y1 - w[g] + (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0)),
                                (d[g].bounds = { x1: l, y1: k + (Y + Z - w[g] - W), x2: m, y2: h, width: m - l, height: h - k }),
                                (W += w[g] + d[g].margin);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (M = p.isNavigator ? 0 : 10),
                                c[g] &&
                                    ...
                                    (M = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : n),
                                    (k = Math.round(f.y1 + Y + Z < Math.max(M, n) ? Math.max(M, n) : f.y1 + Y + Z)),
                                    (m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1)),
                                    (M = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : n),
                                    (h = Math.round(f.y2 - V - e - M)),
                                    (c[g].lineCoordinates = { x1: l - U, y1: k, x2: m - U, y2: h, height: Math.abs(h - k) }),
                                    "inside" === c[g].labelPlacement &&
                                        0 < g &&
                                        ((c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (D[g] - c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0)),
                                        (c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2)),
                                    (c[g].bounds = { x1: l - (D[g] + U), y1: k, x2: m, y2: h, width: m - l, height: h - k }),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                (m = Math.round(l)),
                                (M = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0),
                                (k = Math.round(f.y1 + Y + Z < Math.max(M, n) ? Math.max(M, n) : f.y1 + Y + Z)),
                                (M = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0),
                                (h = Math.round(f.y2 - (V + e + M))),
                                (b[g].lineCoordinates = { x1: l + X, y1: k, x2: l + X, y2: h, height: Math.abs(h - k) }),
                                ...
                                (b[g].bounds = { x1: l, y1: k, x2: m + (C[g] + X), y2: h, width: m - l, height: h - k }),
                    ...
                    if (0 < s) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) B = N[s - 1][g] === N[s][g] ? !0 : !1;
                        else B = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) I = Q[s - 1][g] === Q[s][g] ? !0 : !1;
                        else I = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) P = S[s - 1][g] === S[s][g] ? !0 : !1;
                        else P = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) L = T[s - 1][g] === T[s][g] ? !0 : !1;
                        else L = !0;
                    }
                    if (B && I && P && L) break;
                    s++;
                ...
                for (Q = []; 4 > s; ) {
                    ...
                    if (a && 0 < a.length) for (G = [], g = X = 0; g < a.length; g++) G.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), (X += G[g]), (e += a[g] && !p.isNavigator ? a[g].margin : 0);
                    else G.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    N.push(G);
                    if (d && 0 < d.length) for (v = [], g = V = 0; g < d.length; g++) v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), (V += v[g]), (Z += d[g] ? d[g].margin : 0);
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (c[g].lineCoordinates = {}),
                                ...
                                (m = Math.round(f.x2 - V - Z > p.width - 10 ? p.width - 10 : f.x2 - V - Z)),
                                c[g].labelAutoFit &&
                                    !r(x) &&
                                    (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, x) : 0 === c[g].labelAngle ? Math.max(l, x / 2) : l),
                                    0 < !d.length && (m = 0 < c[g].labelAngle ? m - w / 2 : 0 === c[g].labelAngle ? m - w / 2 : m)),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            (b[g].lineCoordinates = {}),
                                (l = Math.round(f.x1 + X + e)),
                                (m = Math.round(f.x2 - V - Z > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - V - Z)),
                                b[g] && b[g].labelAutoFit && !r(D) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, D) : 0 === b[g].labelAngle ? Math.max(l, D / 2) : l), 0 < !d.length && (m -= C / 2)),
                    ...
                    if (c && 0 < c.length) for (n = [], g = U = 0; g < c.length; g++) n.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), (U += n[g] + c[g].margin), (M += c[g].margin);
                    else n.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    E.push(n);
                    if (b && 0 < b.length) for (y = [], g = W = 0; g < b.length; g++) y.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), (W += y[g]), (aa += b[g].margin);
                    else y.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    t.push(y);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            0 < c[g]._labels.length &&
                                ...
                                (x = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                (D = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))),
                                (C = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))));
                    if (p.panEnabled) for (g = 0; g < c.length; g++) n[g] = r(p.sessionVariables.axisY.height) ? (p.sessionVariables.axisY.height = n[g]) : p.sessionVariables.axisY.height;
                    else for (g = 0; g < c.length; g++) p.sessionVariables.axisY.height = n[g];
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--)
                            (k = Math.round(f.y2)),
                                (h = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2)),
                                (c[g].lineCoordinates.y1 = k - (n[g] + c[g].margin + Y)),
                                (c[g].lineCoordinates.y2 = k - (n[g] + c[g].margin + Y)),
                                "inside" === c[g].labelPlacement &&
                                    0 < g &&
                                    ((c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + n[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" === c[g].tickPlacement ? c[g].tickLength : 0)),
                                    (c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2)),
                                (c[g].bounds = { x1: l, y1: k - (n[g] + Y + c[g].margin), x2: m, y2: h - (Y + c[g].margin), width: m - l, height: n[g] }),
                                c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width),
                                (Y += n[g] + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--)
                            b[g] &&
                                ...
                                "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - y[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)),
                                (b[g].bounds = { x1: l, y1: k + (b[g].margin + F), x2: m, y2: h, width: m - l, height: W }),
                                b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width),
                                (F += y[g] + b[g].margin));
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            ...
                            h =
                                c && 0 < c.length
                                    ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > p.height - Math.max(M, 10) ? p.height - Math.max(M, 10) : f.y2 - U)
                                    : f.y2 > p.height - Math.max(M, 10)
                                    ? p.height - Math.max(M, 10)
                                    : f.y2;
                            if (c && 0 < c.length)
                                for (M = 0; M < c.length; M++)
                                    c[M] && c[M].labelAutoFit && ((m = 0 > c[M].labelAngle ? Math.max(m, x) : 0 === c[M].labelAngle ? Math.max(m, x / 2) : m), (l = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? m - X : l));
                            ...
                            "inside" === a[g].labelPlacement &&
                                0 < g &&
                                ((a[g].lineCoordinates.x1 = a[g].lineCoordinates.x1 - (G[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0)) + ("outside" === a[g].tickPlacement ? a[g].tickLength : 0)),
                                (a[g].lineCoordinates.x2 = a[g].lineCoordinates.x1 + a[g].lineThickness / 2));
                            a[g].bounds = { x1: m - (G[g] + S), y1: k, x2: m, y2: h, width: m - l, height: h - k };
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            if (c && 0 < c.length)
                                for (M = 0; M < c.length; M++)
                                    c[M] && c[M].labelAutoFit && ((m = 0 > c[M].labelAngle ? Math.max(m, x) : 0 === c[M].labelAngle ? Math.max(m, x / 2) : m), (l = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? m - V : l));
                            if (b && 0 < b.length) for (M = 0; M < b.length; M++) b[M] && b[M].labelAutoFit && ((m = b[M].lineCoordinates.x2), (l = m - V));
                            ...
                            d[g].bounds = { x1: d[g].lineCoordinates.x1, y1: k, x2: m + v[g] + T, y2: h, width: m - l, height: h - k };
                    ...
                    if (0 < s) {
                        ...
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) P = E[s - 1][g] === E[s][g] ? !0 : !1;
                        else P = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) L = t[s - 1][g] === t[s][g] ? !0 : !1;
                        else L = !0;
                    }
        ...
        D.render = function (a, d, c, b, e) {
            ...
            e.restore();
            if (a && 0 < a.length) for (l = 0; l < a.length; l++) a[l].renderGrid(), s && (a[l].createMask(), a[l].renderBreaksBackground());
        ...
        D.prototype.renderLabelsTicksAndTitle = function () {
            ...
            if ("undefined" === typeof this.options.interval) {
                if ("bottom" === this._position || "top" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, l, k = this.viewportMaximum, m = this.lineCoordinates.width / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
                            n = this._labels[h];
                            if (n.position < this.viewportMinimum) break;
                            n.position > this.viewportMaximum ||
                                !(h === this._labels.length - 1 || l < (Math.log(k / n.position) * m) / e) ||
                                (c.push(n), (k = n.position), (l = n.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))));
                        }
                        this._labels = c;
                    } else {
                        for (h = 0; h < this._labels.length; h++)
                            (n = this._labels[h]),
                                n.position < this.viewportMinimum || ((l = n.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))), (c += l));
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], p, k = this.viewportMaximum, m = this.lineCoordinates.height / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
                            ...
                            if (n.position < this.viewportMinimum) break;
                            n.position > this.viewportMaximum ||
                                !(h === this._labels.length - 1 || p < Math.log(k / n.position) * m) ||
                                (c.push(n), (k = n.position), (p = n.textBlock.height * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))));
                        }
                        this._labels = c;
                    } else {
                        for (h = 0; h < this._labels.length; h++)
                            (n = this._labels[h]),
                                n.position < this.viewportMinimum || ((p = n.textBlock.height * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))), (b += p));
                                      ...
                                      (q.y =
                                          "inside" === this.labelPlacement
                                              ? 0 > this.labelAngle
                                                  ...
                                                  : q.y - ("inside" === this.tickPlacement ? 0 : this.tickLength) - Math.abs(n.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) + 5)
            ...
            if ("inside" === this.labelPlacement)
                this.chart.addEventListener(
                    ...
                    function () {
                        for (h = 0; h < a._labels.length; h++)
                            (n = a._labels[h]), n.position < a.viewportMinimum || n.position > a.viewportMaximum || (d && 0 !== f++ % 2 && a.labelAutoFit) || (a.ctx.save(), a.ctx.beginPath(), n.textBlock.render(!0), a.ctx.restore());
                    },
                    this
                );
            else for (h = 0; h < this._labels.length; h++) (n = this._labels[h]), n.position < this.viewportMinimum || n.position > this.viewportMaximum || (d && 0 !== f++ % 2 && this.labelAutoFit) || n.textBlock.render(!0);
        };
        ...
        D.prototype.renderStripLinesOfThicknessType = function (a) {
            if (this.stripLines && 0 < this.stripLines.length && a) {
                for (var d = this, c, b = 0, e = 0, f = !1, l = !1, k = [], m = [], l = !1, b = 0; b < this.stripLines.length; b++) {
                    ...
                    h._thicknessType === a &&
                        (("pixel" === a && (h.value < this.viewportMinimum || h.value > this.viewportMaximum || r(h.value) || isNaN(this.range))) ||
                            ("value" === a &&
                                ((h.startValue <= this.viewportMinimum && h.endValue <= this.viewportMinimum) ||
                                    (h.startValue >= this.viewportMaximum && h.endValue >= this.viewportMaximum) ||
                                    r(h.startValue) ||
                                    r(h.endValue) ||
                                    isNaN(this.range))) ||
                            k.push(h));
                                ...
                                "bottom" === this._position
                                    ? ((c.textBlock.maxWidth = this.options.stripLines[b].labelMaxWidth ? this.options.stripLines[b].labelMaxWidth : this.chart.plotArea.height - 3),
                                      ...
                                      a.x - c.textBlock.height > this.chart.plotArea.x1
                                          ...
                                          : ((c.textBlock.angle = 90), r(h.startValue) ? (a.x += c.textBlock.height - c.textBlock.fontSize / 2) : (a.x += c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3)),
                                      (a.y =
                ...
                if (this.lineThickness) {
                    ...
                    if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex))
                        if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
                            ...
                            for (var k = this.scaleBreaks.firstBreakIndex; k <= this.scaleBreaks.lastBreakIndex; k++)
                                d.moveTo(e, l), d.lineTo(this.scaleBreaks._appliedBreaks[k].startPixel + c, l), (e = this.scaleBreaks._appliedBreaks[k].endPixel + b);
                ...
                if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex))
                    if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;
                        ...
                        for (k = this.scaleBreaks.firstBreakIndex; k <= this.scaleBreaks.lastBreakIndex; k++)
                            d.moveTo(l, e), d.lineTo(l, this.scaleBreaks._appliedBreaks[k].startPixel + b), (e = this.scaleBreaks._appliedBreaks[k].endPixel + c);
                ...
                if ("axisX" === this.type && c) {
                    this.intervalType ||
                        (b / 1 <= a
                            ...
                            : ((this.interval = b / (1 * T.yearDuration) <= a ? 1 : b / (2 * T.yearDuration) <= a ? 2 : b / (4 * T.yearDuration) <= a ? 4 : Math.floor(D.getNiceNumber(b / (a - 1), !0) / T.yearDuration)),
        ...
        D.prototype.calculateLogarithmicAxisParameters = function () {
            ...
            var k = (isNaN(this.viewportMaximum) || null === this.viewportMaximum ? e : this.viewportMaximum) - (isNaN(this.viewportMinimum) || null === this.viewportMinimum ? b : this.viewportMinimum);
            this.intervalType = "number";
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (
                        ...
                        "top" === this.scaleBreaks.parent._position
                            ? ((e = this.chart.plotArea.y1), (k = (this.chart.plotArea.y2 + n / 2 + 0.5) << 0))
                            : ((e = this.chart.plotArea.y2), (k = (this.chart.plotArea.y1 - n / 2 + 0.5) << 0), (a *= -1)),
                    ...
                    if (
                        ...
                        "left" === this.scaleBreaks.parent._position
                            ? ((b = this.chart.plotArea.x1), (l = (this.chart.plotArea.x2 + n / 2 + 0.5) << 0))
                            : ((b = this.chart.plotArea.x2), (l = (this.chart.plotArea.x1 - n / 2 + 0.5) << 0), (a *= -1)),
        ...
        N.prototype.render = function () {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    (e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0), (l = this.chart.plotArea.y1), (k = this.chart.plotArea.y2), (this.bounds = { x1: e - d / 2, y1: l, x2: f + d / 2, y2: k });
                else if ("left" === this.parent._position || "right" === this.parent._position)
                    (l = k = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0), (e = this.chart.plotArea.x1), (f = this.chart.plotArea.x2), (this.bounds = { x1: e, y1: l - d / 2, x2: f, y2: k + d / 2 });
                this.ctx.moveTo(e, l);
                this.ctx.lineTo(f, k);
                this.ctx.stroke();
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    for (var w = 0; w < this.parent.dataSeries.length; w++)
                        (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && ((v.dataSeries = this.parent.dataSeries[w]), null !== v.dataPoint.y && v.dataSeries.visible && p.push(v));
                    v = null;
                    ...
                    if ("rangeBar" === p[0].dataSeries.type || "error" === p[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(p[w].dataPoint.y[0])), t = 0, s = 0; s < p.length; s++)
                            if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (var x = 0; x < p[s].dataPoint.y.length; x++) (t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x]))), t < v && ((v = t), (w = s));
                            else (t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y))), t < v && ((v = t), (w = s));
                    else if ("stackedBar" === p[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), A = (t = 0), s = (w = 0); s < p.length; s++)
                            if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++) (t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x]))), t < v && ((v = t), (w = s));
                            else (A += p[s].dataPoint.y), (t = Math.abs(a - this.parent.convertValueToPixel(A))), t < v && ((v = t), (w = s));
                    else if ("stackedBar100" === p[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), E = (A = t = 0), s = 0; s < p.length; s++)
                            if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++) (t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x]))), t < v && ((v = t), (w = s));
                            else
                                (A += p[s].dataPoint.y),
                                    (E = p[s].dataPoint.x.getTime ? p[s].dataPoint.x.getTime() : p[s].dataPoint.x),
                                    (E = 100 * (A / p[s].dataSeries.plotUnit.dataPointYSums[E])),
                                    (t = Math.abs(a - this.parent.convertValueToPixel(E))),
                                    t < v && ((v = t), (w = s));
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), s = w = t = 0; s < p.length; s++)
                            if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++) (t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x]))), t < v && ((v = t), (w = s));
                            else (t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y))), t < v && ((v = t), (w = s));
                    x = p[w];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
                            ...
                            h.text = this.labelFormatter
                                ...
                                ? fa(c ? c : x.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                            ...
                            h.text = this.labelFormatter
                                ...
                                : r(this.options.label)
                                ? fa(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                            ...
                            (k = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0),
                                (h.text = this.labelFormatter
                                    ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y })
                                    : r(this.options.label)
                                    ? fa(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo)
                        ...
                        if (E) {
                            if ("axisX" === this.parent.type)
                                for (s = this.parent.convertPixelToValue({ y: d }), v = null, w = 0; w < this.parent.dataSeries.length; w++)
                            ...
                            "dateTime" === this.parent.valueType
                                ...
                                : "number" === this.parent.valueType &&
                                  (h.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.x })
                                      : r(this.options.label)
                                      ? fa(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                                      : this.label);
                        h.y = l + h.fontSize / 2 - h.measureText().height / 2 + 2;
                        h.y - h.fontSize / 2 < this.chart.bounds.y1
                            ? (h.y = this.chart.bounds.y1 + h.fontSize / 2 + 2)
                            : h.y + h.measureText().height - h.fontSize / 2 > this.chart.bounds.y2 && (h.y = this.chart.bounds.y2 - h.measureText().height + h.fontSize / 2);
                    ...
                    if (E) {
                        if ("axisX" === this.parent.type)
                            for (s = this.parent.convertPixelToValue({ x: a }), v = null, w = 0; w < this.parent.dataSeries.length; w++)
                                (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) &&
                                    0 <= v.index &&
                                    (h.text = this.labelFormatter
                                        ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x })
                    ...
                    if (
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y[0])), s = t = 0; s < p.length; s++)
                            if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++) (t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y[x]))), t < v && ((v = t), (w = s));
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), s = A = t = 0; s < p.length; s++)
                            if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++) (t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y[x]))), t < v && ((v = t), (w = s));
                            else (A += p[s].dataPoint.y), (t = Math.abs(d - this.parent.convertValueToPixel(A))), t < v && ((v = t), (w = s));
                    else if ("stackedColumn100" === p[0].dataSeries.type || "stackedArea100" === p[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), s = E = A = t = 0; s < p.length; s++)
                            if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++) (t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y[x]))), t < v && ((v = t), (w = s));
                            else
                                (A += p[s].dataPoint.y),
                                    (E = p[s].dataPoint.x.getTime ? p[s].dataPoint.x.getTime() : p[s].dataPoint.x),
                        ...
                        "waterfall" === this.parent.dataSeries[w].type
                            ? ((m =
                              ...
                              (h.text = this.labelFormatter
                                  ...
                                  : r(this.options.label)
                                  ? fa(c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label),
                              (this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum))
                            : ((m = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : r(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0),
                              (h.text = this.labelFormatter
                ...
                p = null;
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    "top" === this.parent._position && h.y - h.fontSize / 2 < this.chart.bounds.y1 && (h.y = this.chart.bounds.y1 + h.fontSize / 2),
                        "bottom" === this.parent._position && this.parent.lineCoordinates.y2 - h.fontSize / 2 + h.measureText().height > this.chart.bounds.y2 && (h.y = this.chart.bounds.y2 - h.height + h.fontSize / 2 + 2),
                        b >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) &&
                            ...
                            (0 < n && (q.moveTo(b, f), q.lineTo(e, l), q.stroke(), (this._hidden = !1)), q.restore(), !r(h.text) && ("number" === typeof h.text.valueOf() || 0 < h.text.length) && h.render(!0));
                if ("left" === this.parent._position || "right" === this.parent._position)
                    "left" === this.parent._position && h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1),
                        "right" === this.parent._position && h.x + h.measureText().width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.measureText().width),
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    (b = e = k = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0), (f = this.chart.plotArea.y1), (l = this.chart.plotArea.y2), (this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: l });
                else if ("left" === this.parent._position || "right" === this.parent._position)
                    (f = l = m = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0), (b = this.chart.plotArea.x1), (e = this.chart.plotArea.x2), (this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: l + n / 2 });
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        E = !1;
                        if (this.parent.labels)
                            ...
                            "dateTime" === this.parent.valueType
                                ...
                                : "number" === this.parent.valueType &&
                                  (h.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(d) })
                                      : r(this.options.label)
                                      ? fa(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo)
                                      : this.label);
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position)
                            (h.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) })
                                : r(this.options.label)
                                ? fa(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo)
                                : this.label),
                                (h.x = b - h.measureText().width / 2),
                                h.x + h.width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.width),
                                h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1),
                ...
                "left" === this.parent._position && h.x < this.chart.bounds.x1
                    ...
                    : "right" === this.parent._position && h.x + h.measureText().width > this.chart.bounds.x2
                    ? (h.x = this.chart.bounds.x2 - h.measureText().width)
                    : "top" === this.parent._position && h.y - h.fontSize / 2 < this.chart.bounds.y1
                    ...
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var m = 0; m < this.chart.axisX.length; m++) {
                                for (var l = this.chart.axisX[m].convertPixelToValue({ y: d }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)
                                    (h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= h.index && ((h.dataSeries = this.chart.axisX[m].dataSeries[b]), null !== h.dataPoint.y && k.push(h));
                                h = null;
                            }
                        if (this.chart.axisX2)
                            for (m = 0; m < this.chart.axisX2.length; m++) {
                                ...
                                for (b = 0; b < this.chart.axisX2[m].dataSeries.length; b++)
                                    (h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= h.index && ((h.dataSeries = this.chart.axisX2[m].dataSeries[b]), null !== h.dataPoint.y && k.push(h));
                                h = null;
                            }
                    } else {
                        k = [];
                        if (this.chart.axisX)
                            for (m = 0; m < this.chart.axisX.length; m++)
                                for (l = this.chart.axisX[m].convertPixelToValue({ x: a }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)
                                    (h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= h.index && ((h.dataSeries = this.chart.axisX[m].dataSeries[b]), null !== h.dataPoint.y && k.push(h));
                        if (this.chart.axisX2)
                            for (m = 0; m < this.chart.axisX2.length; m++)
                                for (l = this.chart.axisX2[m].convertPixelToValue({ x: a }), h = null, b = 0; b < this.chart.axisX2[m].dataSeries.length; b++)
                                    (h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= h.index && ((h.dataSeries = this.chart.axisX2[m].dataSeries[b]), null !== h.dataPoint.y && k.push(h));
                    }
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        if (0 <= this.currentDataPointIndex)
                            (b = e.dataPoints[this.currentDataPointIndex]),
                                ...
                                "waterfall" === e.type && ((h.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue), (h.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum));
                        else {
                            if (
                                !this.enabled ||
                                ("line" !== e.type &&
                            ...
                            if (h.dataSeries.axisY)
                                if (0 < h.dataPoint.y.length) {
                                    ...
                                    "column" === e.type || "bar" === e.type
                                        ? 0 > h.dataPoint.y
                                            ? 0 > h.dataSeries.axisY.viewportMinimum && h.dataSeries.axisY.viewportMaximum >= h.dataPoint.y && f.push(h)
                                            : h.dataSeries.axisY.viewportMinimum <= h.dataPoint.y && 0 <= h.dataSeries.axisY.viewportMaximum && f.push(h)
                                        : "bubble" === e.type
                                        ? ((c = this.chart._eventManager.objectMap[e.dataPointIds[h.index]].size / 2),
                                          h.dataPoint.y >= h.dataSeries.axisY.viewportMinimum - c && h.dataPoint.y <= h.dataSeries.axisY.viewportMaximum + c && f.push(h))
                                        : "waterfall" === e.type
                                        ? ((c = 0),
                                          h.cumulativeSumYStartValue < h.dataSeries.axisY.viewportMinimum ? c-- : h.cumulativeSumYStartValue > h.dataSeries.axisY.viewportMaximum && c++,
                                          h.cumulativeSum < h.dataSeries.axisY.viewportMinimum ? c-- : h.cumulativeSum > h.dataSeries.axisY.viewportMaximum && c++,
                                          2 > c && -2 < c && f.push(h))
                                        : (0 <= h.dataSeries.type.indexOf("100") ||
                                              "stackedColumn" === e.type ||
                                              "stackedBar" === e.type ||
                                              (h.dataPoint.y >= h.dataSeries.axisY.viewportMinimum && h.dataPoint.y <= h.dataSeries.axisY.viewportMaximum)) &&
                                          f.push(h);
                            else f.push(h);
                    }
                }
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    ...
                    !1 === f.highlightEnabled ||
                        ...
                        "rangeArea" === b.type ||
                        "rangeSplineArea" === b.type
                            ? ((f = b.getMarkerProperties(l, e.x1, e.y1, this.chart.overlaidCanvasCtx)),
                              ...
                              "undefined" !== typeof e.y2 &&
                                  ((f = b.getMarkerProperties(l, e.x1, e.y2, this.chart.overlaidCanvasCtx)),
                                  (f.size = Math.max((1.5 * f.size) << 0, 10)),
                                  (f.borderColor = f.borderColor || "#FFFFFF"),
                                  (f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size)),
                                  Y.drawMarkers([f])))
                            : "bubble" === b.type
                            ? ((f = b.getMarkerProperties(l, e.x1, e.y1, this.chart.overlaidCanvasCtx)), (f.size = e.size), (f.color = "white"), (f.borderColor = "white"), (d.globalAlpha = 0.3), Y.drawMarkers([f]), (d.globalAlpha = 1))
                            : "column" === b.type ||
                            ...
                            ? Z(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius)
                            ...
                            ? (d.save(),
                              ...
                              d.restore(),
                              (d.globalAlpha = 1))
                            : "error" === b.type && w(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3));
                }
            }
            d.restore();
            d.globalAlpha = 1;
        ...
        aa.prototype.getToolTipInnerHTML = function (a) {
            ...
            if (l && ((this.content && "function" === typeof this.content) || this.contentFormatter)) (a = { chart: this.chart, toolTip: this.options, entries: a }), (d = this.contentFormatter ? this.contentFormatter(a) : this.content(a));
                    ...
                    (c = a[k].dataSeries),
                        ...
                        0 === k &&
                            ...
                            (this.chart.axisX && 0 < this.chart.axisX.length
                                ? (h += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ? this.chart.axisX[0].labels[b.x] : "{x}")
                                : this.chart.axisX2 && 0 < this.chart.axisX2.length && (h += "undefined" !== typeof this.chart.axisX2[0].labels[b.x] ? this.chart.axisX2[0].labels[b.x] : "{x}"),
                            (h += "</br>"),
                        ...
                        null === b.toolTipContent ||
                            ...
                            null === d && (d = ""),
                            !0 === this.reversed
                                ? ((d = this.chart.replaceKeywordsWithValue(f, b, c, e) + d), k < a.length - 1 && (d = "</br>" + d))
                                : ((d += this.chart.replaceKeywordsWithValue(f, b, c, e)), k < a.length - 1 && (d += "</br>")));
                null !== d && (d = h + d);
            } else {
                c = a[0].dataSeries;
                b = a[0].dataPoint;
        ...
        aa.prototype.showAtX = function (a, d) {
            ...
            if (this.shared) for (var l = 0; l < this.chart.data.length; l++) (c = this.chart.data[l]), (b = c.getDataPointAtX(a, !1)) && b.dataPoint && !r(b.dataPoint.y) && c.visible && ((b.dataSeries = c), f.push(b));
        ...
        ea.prototype.reset = function () {
            ...
            this.previousDataPointEventObject = null;
            this.eventObjects = [];
            s && (this.ghostCtx.clearRect(0, 0, this.chart.width, this.chart.height), this.ghostCtx.beginPath());
        };
                    ...
                    if (c) {
                        ...
                        "circle" === b
                            ? (c.moveTo(a, d),
                              ...
                              f && c.fill(),
                              k && (l ? c.stroke() : ((m = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = m))))
                            : "square" === b
                            ? (c.beginPath(), c.rect(a - e / 2, d - e / 2, e, e), f && c.fill(), k && (l ? c.stroke() : ((m = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = m))))
                            : "triangle" === b
                            ? (c.beginPath(),
